...
&emsp;&emsp; [ユーティリティ](stdlib_and_concepts.md#SS_10_1)  
&emsp;&emsp;&emsp; [std::move](stdlib_and_concepts.md#SS_10_1_1)  
&emsp;&emsp;&emsp; [std::forward](stdlib_and_concepts.md#SS_10_1_2)  

&emsp;&emsp; [type_traits](stdlib_and_concepts.md#SS_10_2)  
&emsp;&emsp;&emsp; [std::integral_constant](stdlib_and_concepts.md#SS_10_2_1)  
&emsp;&emsp;&emsp; [std::true_type](stdlib_and_concepts.md#SS_10_2_2)  
&emsp;&emsp;&emsp; [std::false_type](stdlib_and_concepts.md#SS_10_2_3)  
&emsp;&emsp;&emsp; [std::is_same](stdlib_and_concepts.md#SS_10_2_4)  
&emsp;&emsp;&emsp; [std::enable_if](stdlib_and_concepts.md#SS_10_2_5)  
&emsp;&emsp;&emsp; [std::conditional](stdlib_and_concepts.md#SS_10_2_6)  
&emsp;&emsp;&emsp; [std::is_void](stdlib_and_concepts.md#SS_10_2_7)  
&emsp;&emsp;&emsp; [std::is_copy_assignable](stdlib_and_concepts.md#SS_10_2_8)  
&emsp;&emsp;&emsp; [std::is_move_assignable](stdlib_and_concepts.md#SS_10_2_9)  

&emsp;&emsp; [並列処理](stdlib_and_concepts.md#SS_10_3)  
&emsp;&emsp;&emsp; [std::thread](stdlib_and_concepts.md#SS_10_3_1)  
&emsp;&emsp;&emsp; [std::mutex](stdlib_and_concepts.md#SS_10_3_2)  
&emsp;&emsp;&emsp; [std::atomic](stdlib_and_concepts.md#SS_10_3_3)  
&emsp;&emsp;&emsp; [std::condition_variable](stdlib_and_concepts.md#SS_10_3_4)  

&emsp;&emsp; [ロック所有ラッパー](stdlib_and_concepts.md#SS_10_4)  
&emsp;&emsp;&emsp; [std::lock_guard](stdlib_and_concepts.md#SS_10_4_1)  
&emsp;&emsp;&emsp; [std::unique_lock](stdlib_and_concepts.md#SS_10_4_2)  
&emsp;&emsp;&emsp; [std::scoped_lock](stdlib_and_concepts.md#SS_10_4_3)  
...
&emsp;&emsp;&emsp; [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_10_6_2)  
&emsp;&emsp;&emsp; [pool_resource](stdlib_and_concepts.md#SS_10_6_3)  

&emsp;&emsp; [コンテナ](stdlib_and_concepts.md#SS_10_7)  
&emsp;&emsp;&emsp; [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_10_7_1)  
&emsp;&emsp;&emsp;&emsp; [std::forward_list](stdlib_and_concepts.md#SS_10_7_1_1)  

&emsp;&emsp;&emsp; [連想コンテナ(Associative Containers)](stdlib_and_concepts.md#SS_10_7_2)  
&emsp;&emsp;&emsp; [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_10_7_3)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_set](stdlib_and_concepts.md#SS_10_7_3_1)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_map](stdlib_and_concepts.md#SS_10_7_3_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_index](stdlib_and_concepts.md#SS_10_7_3_3)  

&emsp;&emsp;&emsp; [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_10_7_4)  
&emsp;&emsp;&emsp; [特殊なコンテナ](stdlib_and_concepts.md#SS_10_7_5)  

&emsp;&emsp; [std::optional](stdlib_and_concepts.md#SS_10_8)  
&emsp;&emsp;&emsp; [戻り値の無効表現](stdlib_and_concepts.md#SS_10_8_1)  
&emsp;&emsp;&emsp; [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_10_8_2)  

&emsp;&emsp; [std::variant](stdlib_and_concepts.md#SS_10_9)  
&emsp;&emsp; [オブジェクトの比較](stdlib_and_concepts.md#SS_10_10)  
&emsp;&emsp;&emsp; [std::rel_ops](stdlib_and_concepts.md#SS_10_10_1)  
&emsp;&emsp;&emsp; [std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_10_10_2)  

&emsp;&emsp; [その他](stdlib_and_concepts.md#SS_10_11)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](stdlib_and_concepts.md#SS_10_11_1)  
&emsp;&emsp;&emsp; [heap allocation elision](stdlib_and_concepts.md#SS_10_11_2)  
...
std::moveは引数を[rvalueリファレンス](core_lang_spec.md#SS_9_8_2)に変換する関数テンプレートである。

|引数                 |std::moveの動作                                    |
|---------------------|---------------------------------------------------|
|非const [lvalue](core_lang_spec.md#SS_9_7_1_1)|引数を[rvalueリファレンス](core_lang_spec.md#SS_9_8_2)にキャストする      |
|const [lvalue](core_lang_spec.md#SS_9_7_1_1)  |引数をconst [rvalueリファレンス](core_lang_spec.md#SS_9_8_2)にキャストする|
...
* [perfect forwarding](core_lang_spec.md#SS_9_8_5)
...
- [std::integral_constant](stdlib_and_concepts.md#SS_10_2_1)
- [std::true_type](stdlib_and_concepts.md#SS_10_2_2)/[std::false_type](stdlib_and_concepts.md#SS_10_2_3)
- [std::is_same](stdlib_and_concepts.md#SS_10_2_4)
- [std::enable_if](stdlib_and_concepts.md#SS_10_2_5)
- [std::conditional](stdlib_and_concepts.md#SS_10_2_6)
- [std::is_void](stdlib_and_concepts.md#SS_10_2_7)
- [std::is_copy_assignable](stdlib_and_concepts.md#SS_10_2_8)
- [std::is_move_assignable](stdlib_and_concepts.md#SS_10_2_9)
...
`std::true_type`(と`std::false_type`)は真/偽を返す標準ライブラリの[メタ関数](core_lang_spec.md#SS_9_11_2)群の戻り型となる型エイリアスであるため、
最も使われるテンプレートの一つである。

これらは、下記で確かめられる通り、後述する[std::integral_constant](stdlib_and_concepts.md#SS_10_2_1)を使い定義されている。
...
[std::true_type](stdlib_and_concepts.md#SS_10_2_2)を参照せよ。
...
* std::enable_if\<true>::typeは[well-formed](core_lang_spec.md#SS_9_14_2)
* std::enable_if\<false>::typeは[ill-formed](core_lang_spec.md#SS_9_14_1)
...
std::enable_ifのこの特性と後述する[SFINAE](core_lang_spec.md#SS_9_11_1)により、
...
Tが[CopyAssignable要件](cpp_idioms.md#SS_11_5_5)を満たすためには`std::is_copy_assignable<T>`がtrueでなければならないが、
その逆が成立するとは限らない。


### std::is_move_assignable <a id="SS_10_2_9"></a>
std::is_move_assignableはテンプレートパラメータの型(T)がmove代入可能かを調べる。
Tが[MoveAssignable要件](cpp_idioms.md#SS_11_5_4)を満たすためには`std::is_move_assignable<T>`がtrueでなければならないが、
その逆が成立するとは限らない。
...
mutexは通常、[std::lock_guard](stdlib_and_concepts.md#SS_10_4_1)と組み合わせて使われる。

### std::atomic <a id="SS_10_3_3"></a>
atomicクラステンプレートは、型Tをアトミック操作するためのものである。
[組み込み型](core_lang_spec.md#SS_9_1_2)に対する特殊化が提供されており、それぞれに特化した演算が用意されている。
[std::mutex](stdlib_and_concepts.md#SS_10_3_2)で示したような単純なコードではstd::atomicを使用して下記のように書く方が一般的である。
...
- [std::lock_guard](stdlib_and_concepts.md#SS_10_4_1)
- [std::unique_lock](stdlib_and_concepts.md#SS_10_4_2)
- [std::scoped_lock](stdlib_and_concepts.md#SS_10_4_3)
...
下記のコード例では、[std::lock_guard](stdlib_and_concepts.md#SS_10_4_1)の説明で述べたようにmutex::lock()、mutex::unlock()を直接呼び出すのではなく、
...
[オブジェクトの排他所有](cpp_idioms.md#SS_11_4_1)を表すために用いられる。所有権は一つのunique_ptrインスタンスに限定され、
...
その`shared_ptr`インスタンスとの関連のみを保持するのため、[オブジェクトの循環所有](cpp_idioms.md#SS_11_4_3)の問題を解決できる。

[オブジェクトの循環所有](cpp_idioms.md#SS_11_4_3)で示した問題のあるクラスの修正版を以下に示す
...
なお、上記コードは[初期化付きif文](core_lang_spec.md#SS_9_9_5_3)を使うことで、
...
[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_10_6_2)はC++17で導入された標準ライブラリのクラスで、
...
* [std::pmr::memory_resource](stdlib_and_concepts.md#SS_10_6_1)  
* [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_10_6_2)  
* [pool_resource](stdlib_and_concepts.md#SS_10_6_3)

### std::pmr::memory_resource <a id="SS_10_6_1"></a>
std::pmr::memory_resourceは、
ユーザー定義のメモリリソースをカスタマイズし、
[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_10_6_2)を通じて利用可能にする[インターフェースクラス](core_lang_spec.md#SS_9_4_11)である。
...
C++のメモリリソース管理を抽象化するための機能を提供する。
[std::pmr::memory_resource](stdlib_and_concepts.md#SS_10_6_1)を基盤とし、
コンテナやアルゴリズムにカスタムメモリアロケーション戦略を容易に適用可能にする。
std::allocatorと異なり、型に依存せず、
ポリモーフィズムを活用してメモリリソースを切り替えられる点が特徴である。

すでに示したmemory_resource_variable([std::pmr::memory_resource](stdlib_and_concepts.md#SS_10_6_1))の単体テストを以下に示すことにより、
...
pool_resourceは[std::pmr::memory_resource](stdlib_and_concepts.md#SS_10_6_1)を基底とする下記の2つの具象クラスである。
...
* [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_10_7_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_10_7_3)
* [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_10_7_4)
* [特殊なコンテナ](stdlib_and_concepts.md#SS_10_7_5)
...
| [std::forward_list](stdlib_and_concepts.md#SS_10_7_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
...
| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](stdlib_and_concepts.md#SS_10_7_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](stdlib_and_concepts.md#SS_10_7_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
| `std::unordered_multimap` | ハッシュテーブルベースのキーと値のペア。キーは重複可能 |
| [std::type_index](stdlib_and_concepts.md#SS_10_7_3_3)    | 型情報型を連想コンテナのキーとして使用するためのクラス |
...
1. 関数の任意の型の[戻り値の無効表現](stdlib_and_concepts.md#SS_10_8_1)を持たせる
2. [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_10_8_2)する(初期化処理が重く、
...
std::variantとstd::visit([Visitor](design_pattern.md#SS_7_2_5)パターンの実装の一種)を組み合わせた場合の使用例を以下に示す。
...
なお、std::rel_opsはC++20から導入された[<=>演算子](core_lang_spec.md#SS_9_6_4_1)により不要になったため、
非推奨とされた。

### std::tuppleを使用した比較演算子の実装方法 <a id="SS_10_10_2"></a>
クラスのメンバが多い場合、[==演算子](core_lang_spec.md#SS_9_6_3)で示したような方法は、
