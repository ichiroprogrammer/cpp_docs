...
* [単一責任の原則(SRP)](solid.md#SS_6_1)
* [オープン・クローズドの原則(OCP)](solid.md#SS_6_2)
* [リスコフの置換原則(LSP)](solid.md#SS_6_3)
* [インターフェース分離の原則(ISP)](solid.md#SS_6_4)
* [依存関係逆転の原則(DIP)](solid.md#SS_6_5)
...
後述する「[依存関係逆転の原則(DIP)](solid.md#SS_6_5)」にも反している。
...
(実際には、TransactorIFから派生する具象クラスの生成用Factory関数(「[Factory](design_pattern.md#SS_7_1_4)」参照)
...
[Pimpl](cpp_idioms.md#SS_11_2_1)のようにラッピングを使用するパターンも有用である。
...
ところが実際にはオブジェクトの[スライシング](cpp_idioms.md#SS_11_10_3)という別の問題を引き起こす。  
