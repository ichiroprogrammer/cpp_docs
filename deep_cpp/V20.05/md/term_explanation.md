...
&emsp;&emsp;&emsp; [強い安全性の保証](term_explanation.md#SS_6_16_2)  
&emsp;&emsp;&emsp; [基本的な安全性の保証](term_explanation.md#SS_6_16_3)  
&emsp;&emsp;&emsp; [noexcept](term_explanation.md#SS_6_16_4)  
&emsp;&emsp;&emsp; [exception-unfriendly](term_explanation.md#SS_6_16_5)  
...
&emsp;&emsp;&emsp; [サイクロマティック複雑度](term_explanation.md#SS_6_20_2)  
&emsp;&emsp;&emsp; [凝集度](term_explanation.md#SS_6_20_3)  
&emsp;&emsp;&emsp;&emsp; [凝集度の欠如](term_explanation.md#SS_6_20_3_1)  
&emsp;&emsp;&emsp;&emsp; [LCOMの評価基準](term_explanation.md#SS_6_20_3_2)  
...
* [強い安全性の保証](term_explanation.md#SS_6_16_2)
* [基本的な安全性の保証](term_explanation.md#SS_6_16_3)
...
の呼び出しでエクセプションがthrowされると、[未定義動作](term_explanation.md#SS_6_18_7)や[未規定動作](term_explanation.md#SS_6_18_8)が発生するため、
...
「[凝集度の欠如](term_explanation.md#SS_6_20_3_1)(LCOM)」というメトリクスで計測される。

* [凝集度の欠如](term_explanation.md#SS_6_20_3_1)メトリクスの値が1に近ければ凝集度は低く、この値が0に近ければ凝集度は高い。
* メンバ変数やメンバ関数が多くなれば、凝集度は低くなりやすい。
* 凝集度は、クラスのメンバがどれだけ一貫した責任を持つかを示す。
* 「[単一責任の原則(SRP)](solid.md#SS_2_1)」を守ると凝集度は高くなりやすい。
* 「[Accessor](design_pattern.md#SS_3_4)」を多用すれば、振る舞いが分散しがちになるため、通常、凝集度は低くなる。
...
[凝集度](term_explanation.md#SS_6_20_3)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
[LCOMの評価基準](term_explanation.md#SS_6_20_3_2)に具体的な推奨値を示す。
