...
(実際には、TransactorIFから派生する具象クラスの生成用Factory関数(「[Factory](design_pattern.md#SS_3_1_4)」参照)
...
[Pimpl](cpp_idioms.md#SS_8_2_1)のようにラッピングを使用するパターンも有用である。
...
ところが実際にはオブジェクトの[スライシング](cpp_idioms.md#SS_8_10_3)という別の問題を引き起こす。  
