&emsp;&emsp;&emsp; [ill-formed](term_explanation.md#SS_6_10_8)  
&emsp;&emsp;&emsp; [well-formed](term_explanation.md#SS_6_10_9)  
&emsp;&emsp;&emsp; [one-definition rule](term_explanation.md#SS_6_10_10)  
&emsp;&emsp;&emsp; [ODR](term_explanation.md#SS_6_10_11)  
&emsp;&emsp;&emsp; [RVO(Return Value Optimization)](term_explanation.md#SS_6_10_12)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](term_explanation.md#SS_6_10_13)  
&emsp;&emsp;&emsp; [Most Vexing Parse](term_explanation.md#SS_6_10_14)  
&emsp;&emsp;&emsp; [RTTI](term_explanation.md#SS_6_10_15)  
&emsp;&emsp;&emsp; [Run-time Type Information](term_explanation.md#SS_6_10_16)  
&emsp;&emsp;&emsp; [simple-declaration](term_explanation.md#SS_6_10_17)  
&emsp;&emsp;&emsp; [typeid](term_explanation.md#SS_6_10_18)  
&emsp;&emsp;&emsp; [トライグラフ](term_explanation.md#SS_6_10_19)  
&emsp;&emsp;&emsp; [フリースタンディング環境](term_explanation.md#SS_6_10_20)  

&emsp;&emsp; [ソフトウェア一般](term_explanation.md#SS_6_11)  
&emsp;&emsp;&emsp; [凝集度](term_explanation.md#SS_6_11_1)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](term_explanation.md#SS_6_11_2)  
&emsp;&emsp;&emsp; [Spurious Wakeup](term_explanation.md#SS_6_11_3)  
&emsp;&emsp;&emsp; [副作用](term_explanation.md#SS_6_11_4)  
&emsp;&emsp;&emsp; [is-a](term_explanation.md#SS_6_11_5)  
&emsp;&emsp;&emsp; [has-a](term_explanation.md#SS_6_11_6)  
&emsp;&emsp;&emsp; [is-implemented-in-terms-of](term_explanation.md#SS_6_11_7)  

&emsp;&emsp; [非ソフトウェア用語](term_explanation.md#SS_6_12)  
&emsp;&emsp;&emsp; [割れ窓理論](term_explanation.md#SS_6_12_1)  
&emsp;&emsp;&emsp; [車輪の再発明](term_explanation.md#SS_6_12_2)  
...
といったセマンティクス的観点(「[シンタックス、セマンティクス](term_explanation.md#SS_6_8)」参照)によるものである。
...
オブジェクトの所有権やその移動、
std::unique_ptr、std::move()、[rvalue](term_explanation.md#SS_6_5_3)の関係を解説する。
...
下記に示した上記クラスの単体テストにより、
オブジェクトの所有権やその移動、共有、
std::shared_ptr、std::move()、[rvalue](term_explanation.md#SS_6_5_3)の関係を解説する。
...
* prvalue(「[rvalue](term_explanation.md#SS_6_5_3)」参照)のライフタイム
...
仮想関数呼び出しを行う(「[オーバーライドとオーバーロードの違い](term_explanation.md#SS_6_10_1)」参照)
ためのメモリレイアウトが必要になる。
...
各クラスがvtblへのポインタを保持するため、このドキュメントで使用している[g++](term_explanation.md#SS_6_9_1)では、
...
スライシングが起こった場合、そうならないことが問題である(「[等価性のセマンティクス](term_explanation.md#SS_6_8_1)」参照)。
...
3. TypeNameは関数テンプレートであるためtwo phase lookupが以下のように行われる。
    ...
    2. TypeName内でのToType(t)の呼び出しに対しては、2nd name lookupが行われる。
       ...
       グローバル名前空間内のToTypeは、
       NS_TPLU内でTypeNameより前に宣言されたtemplate<> ToTypeによって[name-hiding](term_explanation.md#SS_6_4_8)が起こり、
...
サンプルコードを[g++](term_explanation.md#SS_6_9_1)と[clang++](term_explanation.md#SS_6_9_2)でコンパイルしている)。
...
によるとこの動作は未定義のようだが、
[g++](term_explanation.md#SS_6_9_1)/[clang++](term_explanation.md#SS_6_9_2)両方ともこのコードを警告なしでコンパイルする)。
...
このテストはエラーとならなければならないが、[g++](term_explanation.md#SS_6_9_1)ではパスしてしまう。
2nd name lookupのロジックにバグがあるようである。

有難いことに、[clang++](term_explanation.md#SS_6_9_2)では仕様通りこのテストはエラーとなり、
...
「テンプレートのパラメータ置き換えに失敗した([ill-formed](term_explanation.md#SS_6_10_8)になった)際に、
即時にコンパイルエラーとはせず、置き換えに失敗したテンプレートを
[name lookup](term_explanation.md#SS_6_4_2)の候補から除外する」
という言語機能である。

### name-hiding <a id="SS_6_4_8"></a>
name-hidingとは
...
下記のように[using宣言](term_explanation.md#SS_6_4_13)を使用することで、
...
* [ダイヤモンド継承を含まない場合](term_explanation.md#SS_6_4_9_1)
* [ダイヤモンド継承かつそれが仮想継承でない場合](term_explanation.md#SS_6_4_9_2)
* [ダイヤモンド継承かつそれが仮想継承である場合](term_explanation.md#SS_6_4_9_3)

のドミナンスについてのコードを例示する。

この例で示したように、[ダイヤモンド継承](term_explanation.md#SS_6_4_10)を通常の継承で行うか、
[仮想継承](term_explanation.md#SS_6_4_11)で行うかでは結果が全く異なるため、注意が必要である。

#### ダイヤモンド継承を含まない場合 <a id="SS_6_4_9_1"></a>
...
この[name lookup](term_explanation.md#SS_6_4_2)については、[name-hiding](term_explanation.md#SS_6_4_8)で説明した通りである。

#### ダイヤモンド継承かつそれが仮想継承でない場合 <a id="SS_6_4_9_2"></a>
...
#### ダイヤモンド継承かつそれが仮想継承である場合 <a id="SS_6_4_9_3"></a>
...
これまでと同様にDerived_0のドミナンスによりBase::fは[name-hiding](term_explanation.md#SS_6_4_8)されることになる。
この時、Derived_0、Derived_1がBaseから[仮想継承](term_explanation.md#SS_6_4_11)した効果により、
この継承ヒエラルキーの中でBaseは１つのみ存在することになるため、
Derived_1により導入されたBase::fも併せて[name-hiding](term_explanation.md#SS_6_4_8)される。
結果として、曖昧性は排除され、コンパイルエラーにはならず、このような結果となる。

### ダイヤモンド継承 <a id="SS_6_4_10"></a>
...
ダイヤモンド継承は、
[仮想継承](term_explanation.md#SS_6_4_11)(virtual inheritance)を使ったものと、使わないものに分類できる。

[仮想継承](term_explanation.md#SS_6_4_11)を使わないダイヤモンド継承のコードを以下に示す。
...
次に示すのは、[仮想継承](term_explanation.md#SS_6_4_11)を使用したダイヤモンド継承の例である。
...
(が、[仮想継承](term_explanation.md#SS_6_4_11)による別の問題が発生する)。
...
仮想継承は、[ダイヤモンド継承](term_explanation.md#SS_6_4_10)の基底クラスのインスタンスを、
...
[ダイヤモンド継承](term_explanation.md#SS_6_4_10)での基底クラスのコンストラクタ呼び出しを一度にするために存在する。
...
### 仮想基底 <a id="SS_6_4_12"></a>
仮想基底(クラス)とは、[仮想継承](term_explanation.md#SS_6_4_11)の基底クラス指す。

### using宣言 <a id="SS_6_4_13"></a>
...
[using宣言](term_explanation.md#SS_6_4_13)よりも危険であり、また、
下記のように[name-hiding](term_explanation.md#SS_6_4_8)された識別子の導入には効果がない。
...
「[expression](term_explanation.md#SS_6_5_1)」を参照せよ。
...
[rvalue修飾](term_explanation.md#SS_6_5_4)を参照せよ。


### リファレンス修飾 <a id="SS_6_5_6"></a>
[rvalue修飾](term_explanation.md#SS_6_5_4)と[lvalue修飾](term_explanation.md#SS_6_5_5)とを併せて、リファレンス修飾と呼ぶ。

### decltype <a id="SS_6_5_7"></a>
decltypeはオペランドに[expression](term_explanation.md#SS_6_5_1)を取り、その型を算出する機能である。
...
クロージャ型(「[ラムダ式](term_explanation.md#SS_6_10_4)」参照)
...
* [ユニバーサルリファレンス](term_explanation.md#SS_6_6_1)
* [リファレンスcollapsing](term_explanation.md#SS_6_6_4)
...
下記のコードはジェネリックラムダ(「[ラムダ式](term_explanation.md#SS_6_10_4)」参照)
...
「[ユニバーサルリファレンス](term_explanation.md#SS_6_6_1)」を参照せよ。

### perfect forwarding <a id="SS_6_6_3"></a>
perfect forwarding とは、引数の[rvalue](term_explanation.md#SS_6_5_3)性や
[lvalue](term_explanation.md#SS_6_5_2)性を損失することなく、
その引数を別の関数に転送する技術のことを指す。
通常は、[ユニバーサルリファレンス](term_explanation.md#SS_6_6_1)である関数の仮引数をstd::forwardを用いて、
他の関数に渡すことで実現される。
...
danglingポインタとは、[danglingリファレンス](term_explanation.md#SS_6_6_5)と同じような状態になったポインタを指す。
...
* 「[等価性のセマンティクス](term_explanation.md#SS_6_8_1)」を守ってる
* 「[copyセマンティクス](term_explanation.md#SS_6_8_2)」を守ってる
* 「[moveセマンティクス](term_explanation.md#SS_6_8_3)」を守っている
...
この問題は、[RTTI](term_explanation.md#SS_6_10_15)を使った下記のようなコードで対処できる。
...
従って、これらのオブジェクトに対して[等価性のセマンティクス](term_explanation.md#SS_6_8_1)
...
下記の単体テストから明らかな通り、
「[等価性のセマンティクス](term_explanation.md#SS_6_8_1)」で示した最後の例も、copyセマンティクスを満たしていない。
...
* a == bがtrueの時に、c = std::move(a)が行われた場合、
  ...
  そのリソースはcに移動している」ことが一般的である(「[rvalue](term_explanation.md#SS_6_5_3)」参照)。

* [no-fail保証](term_explanation.md#SS_6_7_1)をする(noexceptと宣言し、エクセプションをthrowしない)。
...
(Derived::g()はオーバーロードでもオーバーライドでもない(「[name-hiding](term_explanation.md#SS_6_4_8)」参照))。
...
* [ジェネリックラムダ](term_explanation.md#SS_6_10_5)とは、C++11のラムダ式を拡張して、
...
対象がテンプレートの場合、事情は少々異なり、[SFINAE](term_explanation.md#SS_6_4_7)によりコンパイルできることもある。


### well-formed <a id="SS_6_10_9"></a>
「[ill-formed](term_explanation.md#SS_6_10_8)」を参照せよ。

### one-definition rule <a id="SS_6_10_10"></a>
「[ODR](term_explanation.md#SS_6_10_11)」を参照せよ。
...
「[RTTI](term_explanation.md#SS_6_10_15)」を参照せよ。
...
### Spurious Wakeup <a id="SS_6_11_3"></a>
...
kyukanchoとstd::stringの関係を[has-a](term_explanation.md#SS_6_11_6)の関係と呼ぶ。


### has-a <a id="SS_6_11_6"></a>
「has-a」の関係は、
...
### is-implemented-in-terms-of <a id="SS_6_11_7"></a>
...
自身の機能を提供する場合に使われる。
[has-a](term_explanation.md#SS_6_11_6)の関係は、is-implemented-in-terms-of の関係の一種である。

is-implemented-in-terms-ofは下記の手段1-3に示した方法がある。

*手段1.* [public継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_11_7_1)  
*手段2.* [private継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_11_7_2)  
*手段3.* [コンポジションによる(has-a)is-implemented-in-terms-of](term_explanation.md#SS_6_11_7_3)  
...
手段1は[is-a](term_explanation.md#SS_6_11_5)に見え、以下に示すような問題も考慮する必要があるため、
可読性、保守性を劣化させる可能性がある。
...
#### public継承によるis-implemented-in-terms-of <a id="SS_6_11_7_1"></a>
...
すでに述べたようにこの方法は、
[private継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_11_7_2)や、
[コンポジションによる(has-a)is-implemented-in-terms-of](term_explanation.md#SS_6_11_7_3)
と比べコードがシンプルになる。 

#### private継承によるis-implemented-in-terms-of <a id="SS_6_11_7_2"></a>
...
この方法は、[public継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_11_7_1)が持つデストラクタ問題は発生せす、
[is-a](term_explanation.md#SS_6_11_5)と誤解してしまう問題も発生しない。


#### コンポジションによる(has-a)is-implemented-in-terms-of <a id="SS_6_11_7_3"></a>
