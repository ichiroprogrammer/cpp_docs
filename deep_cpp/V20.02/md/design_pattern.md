...
* copy代入演算子には、[エクセプション安全性の保証](term_explanation.md#SS_7_10)がない。
...
これにより[エクセプション安全性の保証](term_explanation.md#SS_7_10)を持つ4関数をコードクローンすることなく実装できる。
...
* クラスの理解が曖昧なC++プログラマの理解を助ける(「[クラスのレイアウト](term_explanation.md#SS_6_3_8)」参照)
