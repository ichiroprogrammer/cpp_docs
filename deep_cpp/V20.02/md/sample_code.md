<!-- ./md/sample_code.md -->
# Sample Code <a id="SS_8"></a>
## C++ <a id="SS_8_1"></a>
### example/dynamic_memory_allocation/malloc_ut.cpp <a id="SS_8_1_1"></a>
```cpp
...
### example/dynamic_memory_allocation/mpool_variable.h <a id="SS_8_1_2"></a>
```cpp
          1 #pragma once
          2 #include <cassert>
          3 #include <cstdint>
