...
[フリースタンディング環境](term_explanation.md#SS_6_13_1)では、sbrkのようなシステムコールは存在しないため、
...
まずは、MPoolを下記に示す
(「[ファイル位置を静的に保持したエクセプションクラスの開発](template_meta_programming.md#SS_4_6_6_4)」参照)。
...
コンパイラに[g++](term_explanation.md#SS_6_11_1)や[clang++](term_explanation.md#SS_6_11_2)を使っている場合、
