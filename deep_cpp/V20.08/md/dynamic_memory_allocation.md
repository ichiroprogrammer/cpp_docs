...
(この実装は長いため、
全体は巻末の「[example/dynamic_memory_allocation/malloc_ut.cpp](sample_code.md#SS_7_1_1)」に掲載する)。
...
[フリースタンディング環境](term_explanation.md#SS_6_21_1)では、sbrkのようなシステムコールは存在しないため、
...
* 複数個のメモリプールを統合的に扱う[インターフェースクラス](term_explanation.md#SS_6_3_13)MPool
...
[一様初期化](term_explanation.md#SS_6_5_2)で行った方が良いが、
...
* その他のクラスに対しては、[Singleton](design_pattern.md#SS_3_13)や[Named Constructor](design_pattern.md#SS_3_18)と同様な静的な方法を用いる
...
これを避けるためには、
[CRTP(curiously recurring template pattern)](design_pattern.md#SS_3_22)
...
(全体は巻末の「[example/dynamic_memory_allocation/mpool_variable.h](sample_code.md#SS_7_1_2)」に掲載する)。
...
コンパイラに[g++](term_explanation.md#SS_6_20_1)や[clang++](term_explanation.md#SS_6_20_2)を使っている場合、
...
[std::pmr::polymorphic_allocator](dynamic_memory_allocation.md#SS_5_5_2)を通じて利用可能にする[インターフェースクラス](term_explanation.md#SS_6_3_13)である。
