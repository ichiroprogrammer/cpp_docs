...
上記を抜粋した下記のコードは「縮小型変換を発生さる{}による初期化は[ill-formed](term_explanation.md#SS_6_19_5)になる」
ことをSFINAEに利用している。
...
* [ill-formed](term_explanation.md#SS_6_19_5)ならばill-formedになる
* [well-formed](term_explanation.md#SS_6_19_6)ならvoidを生成する
...
の戻り型が配列型の[rvalue](term_explanation.md#SS_6_14_1_2)である"int (&&) [3]"となり、
...
そのオブジェクトが[lvalue](term_explanation.md#SS_6_14_1_1)(この例ではint (&)[3])であれば、
...
実際、現在使用中の[g++](term_explanation.md#SS_6_20_1)ではこのコードはコンパイルできず、
...
[forwardingリファレンス](term_explanation.md#SS_6_15_3)を使って下記のように書き直した。
...
この原因は、
「関数が受け取った[rvalue](term_explanation.md#SS_6_14_1_2)リファレンスは、
その関数から別の関数に受け渡される時に[lvalue](term_explanation.md#SS_6_14_1_1)リファレンスとして扱われる」からである。
...
(T const&&はconstな[rvalue](term_explanation.md#SS_6_14_1_2)リファレンスである)、
forwardingリファレンスが[lvalue](term_explanation.md#SS_6_14_1_1)リファレンスであった場合は、
...
なお、forwardingリファレンスは、[リファレンスcollapsing](term_explanation.md#SS_6_15_6)の一機能としても理解できる。
...
残念なことにこの関数は非標準であるため、
それを使っているNstd::Inner\_::demangleは[g++](term_explanation.md#SS_6_20_1)/[clang++](term_explanation.md#SS_6_20_2)
でなければコンパイルできないだろう。
...
* [forwardingリファレンス](term_explanation.md#SS_6_15_3)の実際の型がlvalueリファレンスであるならば、
  constなlvalueリファレンスとして扱う
  。

* ユニバーサルリファレンス引数を他の関数に渡すのであれば、std::forwardを使う
  (「[forwardingリファレンス](term_explanation.md#SS_6_15_3)」、「[forwardingリファレンスとstd::forward](template_meta_programming.md#SS_4_7_1)」参照)。
