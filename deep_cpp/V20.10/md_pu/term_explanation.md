...
&emsp;&emsp;&emsp; [ユーティリティ](term_explanation.md#SS_6_9_1)  
&emsp;&emsp;&emsp;&emsp; [std::move](term_explanation.md#SS_6_9_1_1)  
&emsp;&emsp;&emsp;&emsp; [std::forward](term_explanation.md#SS_6_9_1_2)  

&emsp;&emsp;&emsp; [並列処理](term_explanation.md#SS_6_9_2)  
&emsp;&emsp;&emsp;&emsp; [std::thread](term_explanation.md#SS_6_9_2_1)  
&emsp;&emsp;&emsp;&emsp; [std::mutex](term_explanation.md#SS_6_9_2_2)  
&emsp;&emsp;&emsp;&emsp; [std::atomic](term_explanation.md#SS_6_9_2_3)  

&emsp;&emsp;&emsp; [ロック所有ラッパー](term_explanation.md#SS_6_9_3)  
&emsp;&emsp;&emsp;&emsp; [std::lock_guard](term_explanation.md#SS_6_9_3_1)  
&emsp;&emsp;&emsp;&emsp; [std::unique_lock](term_explanation.md#SS_6_9_3_2)  
&emsp;&emsp;&emsp;&emsp; [std::scoped_lock](term_explanation.md#SS_6_9_3_3)  

&emsp;&emsp;&emsp; [スマートポインタ](term_explanation.md#SS_6_9_4)  
&emsp;&emsp;&emsp; [コンテナ](term_explanation.md#SS_6_9_5)  
&emsp;&emsp;&emsp;&emsp; [シーケンスコンテナ(Sequence Containers)](term_explanation.md#SS_6_9_5_1)  
&emsp;&emsp;&emsp;&emsp; [連想コンテナ(Associative Containers)](term_explanation.md#SS_6_9_5_2)  
&emsp;&emsp;&emsp;&emsp; [無順序連想コンテナ(Unordered Associative Containers)](term_explanation.md#SS_6_9_5_3)  
&emsp;&emsp;&emsp;&emsp; [コンテナアダプタ(Container Adapters)](term_explanation.md#SS_6_9_5_4)  
&emsp;&emsp;&emsp;&emsp; [特殊なコンテナ](term_explanation.md#SS_6_9_5_5)  

&emsp;&emsp;&emsp; [std::optional](term_explanation.md#SS_6_9_6)  
&emsp;&emsp;&emsp;&emsp; [戻り値の無効表現](term_explanation.md#SS_6_9_6_1)  
&emsp;&emsp;&emsp;&emsp; [オブジェクトの遅延初期化](term_explanation.md#SS_6_9_6_2)  

&emsp;&emsp;&emsp; [std::variant](term_explanation.md#SS_6_9_7)  
...
X、Yオブジェクトへの[ハンドル](term_explanation.md#SS_6_21_1)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。

#### std::weak_ptr <a id="SS_6_5_7_4"></a>
std::weak_ptrは、[スマートポインタ](term_explanation.md#SS_6_9_4)の一種である。

std::weak_ptrは参照カウントに影響を与えず、`shared_ptr`とオブジェクトを共有所有するのではなく、
その`shared_ptr`インスタンスとの関連のみを保持するのため、[オブジェクトの循環所有](term_explanation.md#SS_6_5_7_3)の問題を解決できる。
...
std::moveは引数を[rvalueリファレンス](term_explanation.md#SS_6_15_2)に変換する関数テンプレートである。

|引数                 |std::moveの動作                                    |
|---------------------|---------------------------------------------------|
|非const [lvalue](term_explanation.md#SS_6_14_1_1)|引数を[rvalueリファレンス](term_explanation.md#SS_6_15_2)にキャストする      |
|const [lvalue](term_explanation.md#SS_6_14_1_1)  |引数をconst [rvalueリファレンス](term_explanation.md#SS_6_15_2)にキャストする|
...
* [perfect forwarding](term_explanation.md#SS_6_15_5)
...
mutexは通常、[std::lock_guard](term_explanation.md#SS_6_9_3_1)と組み合わせて使われる。
...
[組み込み型](term_explanation.md#SS_6_1_2)に対する特殊化が提供されており、それぞれに特化した演算が用意されている。
[std::mutex](term_explanation.md#SS_6_9_2_2)で示したような単純なコードではstd::atomicを使用して下記のように書く方が一般的である。
...
- [std::lock_guard](term_explanation.md#SS_6_9_3_1)
- [std::unique_lock](term_explanation.md#SS_6_9_3_2)
- [std::scoped_lock](term_explanation.md#SS_6_9_3_3)
...
下記のコード例では、[std::lock_guard](term_explanation.md#SS_6_9_3_1)の説明で述べたようにmutex::lock()、mutex::unlock()を直接呼び出すのではなく、
...
一般に条件変数には、[Spurious Wakeup](term_explanation.md#SS_6_21_5)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](term_explanation.md#SS_6_21_5)の対策が行われていないため、
意図通り動作しない可能性がある。
...
* [シーケンスコンテナ(Sequence Containers)](term_explanation.md#SS_6_9_5_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](term_explanation.md#SS_6_9_5_3)
* [コンテナアダプタ(Container Adapters)](term_explanation.md#SS_6_9_5_4)
* [特殊なコンテナ](term_explanation.md#SS_6_9_5_5)
...
| [std::forward_list](term_explanation.md#SS_6_9_5_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
...
| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](term_explanation.md#SS_6_9_5_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](term_explanation.md#SS_6_9_5_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
| `std::unordered_multimap` | ハッシュテーブルベースのキーと値のペア。キーは重複可能 |
| [std::type_index](term_explanation.md#SS_6_9_5_3_3)    | 型情報型を連想コンテナのキーとして使用するためのクラス |
...
1. 関数の任意の型の[戻り値の無効表現](term_explanation.md#SS_6_9_6_1)を持たせる
2. [オブジェクトの遅延初期化](term_explanation.md#SS_6_9_6_2)する(初期化処理が重く、
...
[name lookup](term_explanation.md#SS_6_10_2)の対象外になる」現象一般を指す通称である
...
* **注意** rvalueリファレンス型の変数は、その型が`T&&`であっても、値カテゴリは[lvalue](term_explanation.md#SS_6_14_1_1)である。
...
ref_refの型は`int &&`であるが、ref_refの値カテゴリは[rvalue](term_explanation.md#SS_6_14_1_2)ではなく、[lvalue](term_explanation.md#SS_6_14_1_1)である。
...
この動作を理解することは、
[moveセマンティクス](term_explanation.md#SS_6_18_3)や[perfect forwarding](term_explanation.md#SS_6_15_5)を正しく実装/使用するために極めて重要である。
...
下記GetString0()のような関数が返すオブジェクトの内部メンバに対する[ハンドル](term_explanation.md#SS_6_21_1)は、
...
* リソース管理   
    必須ではないが、aがポインタ等のリソースを保有している場合、
     move代入後にはそのリソースはcに移動していることが一般的である(「[rvalue](term_explanation.md#SS_6_14_1_2)」参照)
...
3. 正しいセマンティクス  
   copy代入によって代入元のオブジェクトが変更されてはならない(「[copyセマンティクス](term_explanation.md#SS_6_18_2)」参照)。
...
「[凝集度の欠如](term_explanation.md#SS_6_21_4_1)(LCOM)」というメトリクスで計測される。

* [凝集度の欠如](term_explanation.md#SS_6_21_4_1)メトリクスの値が1に近ければ凝集度は低く、この値が0に近ければ凝集度は高い。
...
[凝集度](term_explanation.md#SS_6_21_4)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
[LCOMの評価基準](term_explanation.md#SS_6_21_4_2)に具体的な推奨値を示す。
...
kyukanchoとstd::stringの関係を[has-a](term_explanation.md#SS_6_21_8)の関係と呼ぶ。
...
自身の機能を提供する場合に使われる。
[has-a](term_explanation.md#SS_6_21_8)の関係は、is-implemented-in-terms-of の関係の一種である。

is-implemented-in-terms-ofは下記の手段1-3に示した方法がある。

*手段1.* [public継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_21_9_1)  
*手段2.* [private継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_21_9_2)  
*手段3.* [コンポジションによる(has-a)is-implemented-in-terms-of](term_explanation.md#SS_6_21_9_3)  
...
手段1は[is-a](term_explanation.md#SS_6_21_7)に見え、以下に示すような問題も考慮する必要があるため、
可読性、保守性を劣化させる可能性がある。
...
すでに述べたようにこの方法は、
[private継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_21_9_2)や、
[コンポジションによる(has-a)is-implemented-in-terms-of](term_explanation.md#SS_6_21_9_3)
と比べコードがシンプルになる。 
...
この方法は、[public継承によるis-implemented-in-terms-of](term_explanation.md#SS_6_21_9_1)が持つデストラクタ問題は発生せす、
[is-a](term_explanation.md#SS_6_21_7)と誤解してしまう問題も発生しない。
