...
(「[浮動小数点型](term_explanation.md#SS_6_1_9)」参照)
...
であるため、Tがvoidの時のみ[name lookup](term_explanation.md#SS_6_10_2)の対象になる。
...
[SFINAE](term_explanation.md#SS_6_11_1)による[is_same_sfinae_s](template_meta_programming.md#SS_4_3_3_5)の難解なコードを[コンセプト](term_explanation.md#SS_6_11_2)
...
* 第1パラメータが第2パラメータ以降で指定された型のどれかと一致する
  SameAsSomeOfという名前の[コンセプト](term_explanation.md#SS_6_11_2)を[畳み込み式](term_explanation.md#SS_6_11_3)を使用し定義する
...
OneOfの実装にはシンプルに記述するための[畳み込み式](term_explanation.md#SS_6_11_3)を使用した。
...
上記を抜粋した下記のコードは「縮小型変換を発生さる{}による初期化は[ill-formed](term_explanation.md#SS_6_18_5)になる」
ことをSFINAEに利用している。
...
|[Beginable/Endable](template_meta_programming.md#SS_4_3_5_8)              |[コンセプト](term_explanation.md#SS_6_11_2)を使用したexists_begin/exsits_endを単純化した例   |
|[IsRange](template_meta_programming.md#SS_4_3_5_6)                        |exists_begin/exsits_endを使し、範囲forのオペランドになれるか?の判断|
|[Ranged](template_meta_programming.md#SS_4_3_5_9)                         |機能はIsRangeと同一だが、[コンセプト](term_explanation.md#SS_6_11_2)を使用しSFINAEの回避     |
...
以下に示すように、C++20から導入された[コンセプト](term_explanation.md#SS_6_11_2)はこのような問題の軽減につながる。
...
* [ill-formed](term_explanation.md#SS_6_18_5)ならばill-formedになる
* [well-formed](term_explanation.md#SS_6_18_6)ならvoidを生成する
...
の戻り型が配列型の[rvalue](term_explanation.md#SS_6_14_3)である"int (&&) [3]"となり、
...
そのオブジェクトが[lvalue](term_explanation.md#SS_6_14_2)(この例ではint (&)[3])であれば、
...
* [SFINAE](term_explanation.md#SS_6_11_1)を利用した[ExistsPutTo](template_meta_programming.md#SS_4_3_5_13)は複雑で醜いため、リファクタリングする。
...
このような記述が必要になる。
一方で[コンセプト](term_explanation.md#SS_6_11_2)を使用したC++20スタイルのSFINAEの可読性の高さを実感できただろう。
...
ここでも、すでにみてきた[コンセプト](term_explanation.md#SS_6_11_2)による制約によりこの問題に対処する。
...
実際、現在使用中の[g++](term_explanation.md#SS_6_19_1)ではこのコードはコンパイルできず、
...
[浮動小数点型](term_explanation.md#SS_6_1_9)を頻繁に使用するソフトウェアの開発を行うに場合、
ソースコードの中で、場当たり的に浮動小数点型を使用すると、
[浮動小数点の誤差](term_explanation.md#SS_6_1_9_2)や[浮動小数点の演算エラー](term_explanation.md#SS_6_1_9_4)
...
[ユニバーサルリファレンス](term_explanation.md#SS_6_15_1)を使って下記のように書き直した。
...
この原因は、
「関数が受け取った[rvalue](term_explanation.md#SS_6_14_3)リファレンスは、
その関数から別の関数に受け渡される時に[lvalue](term_explanation.md#SS_6_14_2)リファレンスとして扱われる」からである。
...
[畳み込み式](term_explanation.md#SS_6_11_3)を使用した下記の実装の方がより明確である。
...
(T const&&はconstな[rvalue](term_explanation.md#SS_6_14_3)リファレンスである)、
ユニバーサルリファレンスが[lvalue](term_explanation.md#SS_6_14_2)リファレンスであった場合は、
...
なお、ユニバーサルリファレンスは、[リファレンスcollapsing](term_explanation.md#SS_6_15_4)の一機能としても理解できる。
...
この記法は[ジェネリックラムダ](term_explanation.md#SS_6_11_4)と呼ばれる。
...
[ADL](term_explanation.md#SS_6_10_5)(実引数依存探索)により、Appもis_equalの[name lookup](term_explanation.md#SS_6_10_2)の対象になるからである。
...
* [std::enable_if](template_meta_programming.md#SS_4_3_1_4)や[コンセプト](term_explanation.md#SS_6_11_2)等を使用してテンプレートに適用できる型を制約する
...
([two phase name lookup](term_explanation.md#SS_6_10_3)の一回目のname lookupでfがバインドされるため)。
...
[ADL](term_explanation.md#SS_6_10_5)や[two phase name lookup](term_explanation.md#SS_6_10_3)が絡む場合ならなおさらである。

こういう意図しない[name lookup](term_explanation.md#SS_6_10_2)に備えるためには、
...
XY型オブジェクトを引数にした関数呼び出しによる[関連名前空間](term_explanation.md#SS_6_10_6)は、
...
等によるコンパイルエラーとの戦いである。
また、これをクリアしても[two phase name lookup](term_explanation.md#SS_6_10_3)や[ADL](term_explanation.md#SS_6_10_5)が次の関門になる。
...
残念なことにこの関数は非標準であるため、
それを使っているNstd::Inner\_::demangleは[g++](term_explanation.md#SS_6_19_1)/[clang++](term_explanation.md#SS_6_19_2)
でなければコンパイルできないだろう。
...
[暗黙の型変換](term_explanation.md#SS_6_13_1)を利用した文字列リテラルからStaticStringオブジェクトへの変換は、
...
* [name lookup](term_explanation.md#SS_6_10_2)には複雑なルールが適用されるため、非直感的なバインドが行われる場合がある。
  従って、テンプレートライブラリの開発には単体テストは必須である。

* 使用しているコンパイラが[two phase name lookup](term_explanation.md#SS_6_10_3)をサポートしているか否かに気を付ける。
...
* [ADL](term_explanation.md#SS_6_10_5)を利用しない場合、テンプレートで使う識別子は名前空間名やthis->等で修飾する
...
* ユニバーサルリファレンス引数を他の関数に渡すのであれば、std::forwardを使う
  (「[ユニバーサルリファレンス](term_explanation.md#SS_6_15_1)」、「[ユニバーサルリファレンスとstd::forward](template_meta_programming.md#SS_4_7_1)」参照)。

* 関数テンプレートとその特殊化はソースコード上なるべく近い位置で定義する
  (「[two phase name lookup](term_explanation.md#SS_6_10_3)」参照)。

* [two phase name lookup](term_explanation.md#SS_6_10_3)により意図しない副作用が発生する可能性があるため、
...
* 関数テンプレートのオーバーロードと特殊化の[name lookup](term_explanation.md#SS_6_10_2)の優先度に気を付ける。
...
* 意図しないテンプレートパラメータによるインスタンス化の防止や、
  ...
  static_assertによるテンプレートパラメータの制約よりも、[コンセプト](term_explanation.md#SS_6_11_2)による制約を優先する。
