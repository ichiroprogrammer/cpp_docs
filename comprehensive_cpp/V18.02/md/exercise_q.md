...
### 19.1.1 演習-汎整数型の選択 <a id="SS_19_1_1"></a>
* 問題  
...
* [解答-汎整数型の選択](exercise_a.md#SS_20_1_1)


### 19.1.2 演習-汎整数型の演算 <a id="SS_19_1_2"></a>
* 問題
```cpp
...
* [解答例-汎整数型の演算](exercise_a.md#SS_20_1_2)


### 19.1.3 演習-浮動小数点型 <a id="SS_19_1_3"></a>
* 問題
```cpp
...
* [解答例-浮動小数点型](exercise_a.md#SS_20_1_3)


### 19.1.4 演習-定数列挙 <a id="SS_19_1_4"></a>
* 問題  
...
* [解答-定数列挙](exercise_a.md#SS_20_1_4)


### 19.1.5 演習-enum <a id="SS_19_1_5"></a>
* 問題
```cpp
...
* 参照 [enum](programming_convention.md#SS_3_1_2)
* [解答例-enum](exercise_a.md#SS_20_1_5)


### 19.1.6 演習-配列の範囲for文 <a id="SS_19_1_6"></a>
* 問題
```cpp
...
* [解答例-配列の範囲for文](exercise_a.md#SS_20_1_6)


### 19.1.7 演習-エイリアス <a id="SS_19_1_7"></a>
* 問題
...
* [解答例-エイリアス](exercise_a.md#SS_20_1_7)


### 19.1.8 演習-constの意味 <a id="SS_19_1_8"></a>
* 問題  
...
* [解答-constの意味](exercise_a.md#SS_20_1_8)


### 19.1.9 演習-const/constexpr <a id="SS_19_1_9"></a>
* 問題
```cpp
...
* [解答例-const/constexpr](exercise_a.md#SS_20_1_9)


### 19.1.10 演習-危険なconst_cast <a id="SS_19_1_10"></a>
* 問題
```cpp
...
* 参照 [const/constexprインスタンス](programming_convention.md#SS_3_1_9)
* [解答例-危険なconst_cast](exercise_a.md#SS_20_1_10)


### 19.1.11 演習-リテラル <a id="SS_19_1_11"></a>
* 問題
```cpp
...
* 参照 [リテラル](programming_convention.md#SS_3_1_10)

* [解答例-リテラル](exercise_a.md#SS_20_1_11)


### 19.1.12 演習-適切なautoの使い方 <a id="SS_19_1_12"></a>
* 問題  
...
* [解答-適切なautoの使い方](exercise_a.md#SS_20_1_12)


### 19.1.13 演習-ポインタの初期化 <a id="SS_19_1_13"></a>
* 問題  
...
* [解答-ポインタの初期化](exercise_a.md#SS_20_1_13)


### 19.1.14 演習-vector初期化 <a id="SS_19_1_14"></a>
* 問題  
  以下のコード実行後のvecの状態を選べ。
...
* [解答-vector初期化](exercise_a.md#SS_20_1_14)


### 19.1.15 演習-インスタンスの初期化 <a id="SS_19_1_15"></a>
* 問題
```cpp
...
* 参照 [インスタンスの初期化](programming_convention.md#SS_3_1_12)、[一様初期化](term_explanation.md#SS_18_2_7)
* [解答例-インスタンスの初期化](exercise_a.md#SS_20_1_15)


## 19.2 プログラミング規約(クラス) <a id="SS_19_2"></a>

### 19.2.1 演習-凝集度の意味 <a id="SS_19_2_1"></a>
* 問題  
...
* [解答-凝集度の意味](exercise_a.md#SS_20_2_1)


### 19.2.2 演習-凝集度の向上 <a id="SS_19_2_2"></a>
* 問題
```cpp
...
* [解答例-凝集度の向上](exercise_a.md#SS_20_2_2)


### 19.2.3 演習-メンバ変数の初期化方法の選択 <a id="SS_19_2_3"></a>
* 問題  
...
* [解答-メンバ変数の初期化方法の選択](exercise_a.md#SS_20_2_3)


### 19.2.4 演習-メンバの型 <a id="SS_19_2_4"></a>
* 問題  
  以下のA::strの意味を表すものを選べ。
...
* [解答-メンバの型](exercise_a.md#SS_20_2_4)


### 19.2.5 演習-メンバ変数の初期化 <a id="SS_19_2_5"></a>
* 問題
```cpp
...
* 参照 [非静的なメンバ変数/定数の初期化](programming_convention.md#SS_3_2_5)
* [解答例-メンバ変数の初期化](exercise_a.md#SS_20_2_5)


### 19.2.6 演習-スライシング <a id="SS_19_2_6"></a>
* 問題
```cpp
...
* [解答例-スライシング](exercise_a.md#SS_20_2_6)

### 19.2.7 演習-オブジェクトの所有権 <a id="SS_19_2_7"></a>
* 問題
```cpp
...
* [解答例-オブジェクトの所有権](exercise_a.md#SS_20_2_7)


## 19.3 プログラミング規約(関数) <a id="SS_19_3"></a>

### 19.3.1 演習-非メンバ関数の宣言 <a id="SS_19_3_1"></a>
* 問題
```cpp
...
* [解答例-非メンバ関数の宣言](exercise_a.md#SS_20_3_1)


### 19.3.2 演習-メンバ関数の修飾 <a id="SS_19_3_2"></a>
* 問題
```cpp
...
* [解答例-メンバ関数の修飾](exercise_a.md#SS_20_3_2)


### 19.3.3 演習-特殊メンバ関数の削除 <a id="SS_19_3_3"></a>
* 問題
```cpp
...
* [解答例-特殊メンバ関数の削除](exercise_a.md#SS_20_3_3)


### 19.3.4 演習-委譲コンストラクタ <a id="SS_19_3_4"></a>
* 問題
```cpp
...
* [解答例-委譲コンストラクタ](exercise_a.md#SS_20_3_4)


### 19.3.5 演習-copyコンストラクタ <a id="SS_19_3_5"></a>
* 問題
```cpp
...
* 参照 [コンストラクタ](programming_convention.md#SS_3_3_2_2)
* [解答例-copyコンストラクタ](exercise_a.md#SS_20_3_5)


### 19.3.6 演習-moveコンストラクタ <a id="SS_19_3_6"></a>
* 問題
```cpp
...
* [解答例-moveコンストラクタ](exercise_a.md#SS_20_3_6)


### 19.3.7 演習-関数分割 <a id="SS_19_3_7"></a>
* 問題
```cpp
...
* [解答例-関数分割](exercise_a.md#SS_20_3_7)


### 19.3.8 演習-オーバーライド関数の修飾 <a id="SS_19_3_8"></a>
* 問題  
...
* [解答-オーバーライド関数の修飾](exercise_a.md#SS_20_3_8)


### 19.3.9 演習-オーバーライド/オーバーロード <a id="SS_19_3_9"></a>
* 問題
```cpp
...
* [解答例-オーバーライド/オーバーロード](exercise_a.md#SS_20_3_9)


### 19.3.10 演習-オーバーロードによる誤用防止 <a id="SS_19_3_10"></a>
* 問題
```cpp
...
* [解答例-オーバーロードによる誤用防止](exercise_a.md#SS_20_3_10)


### 19.3.11 演習-仮引数の修飾 <a id="SS_19_3_11"></a>
* 問題
```cpp
...
* [解答例-仮引数の修飾](exercise_a.md#SS_20_3_11)


### 19.3.12 演習-constexpr関数 <a id="SS_19_3_12"></a>
* 問題
```cpp
...
* 参照 [constexpr関数](programming_convention.md#SS_3_3_3_8)
* [解答例-constexpr関数](exercise_a.md#SS_20_3_12)


### 19.3.13 演習-エクセプションの型 <a id="SS_19_3_13"></a>
* 問題  
...
* [解答-エクセプションの型](exercise_a.md#SS_20_3_13)


## 19.4 プログラミング規約(構文) <a id="SS_19_4"></a>

### 19.4.1 演習-コンテナの範囲for文 <a id="SS_19_4_1"></a>
* 問題
```cpp
...
* 参照 [範囲for文](programming_convention.md#SS_3_4_4)
* [解答例-コンテナの範囲for文](exercise_a.md#SS_20_4_1)


### 19.4.2 演習-ラムダ式 <a id="SS_19_4_2"></a>
* 問題
```cpp
...
* 参照 [ラムダ式](programming_convention.md#SS_3_4_8)
* [解答例-ラムダ式](exercise_a.md#SS_20_4_2)


### 19.4.3 演習-ラムダ式のキャプチャ <a id="SS_19_4_3"></a>
* 問題
```cpp
...
* 参照 [ラムダ式](programming_convention.md#SS_3_4_8)
* [解答例-ラムダ式のキャプチャ](exercise_a.md#SS_20_4_3)

## 19.5 プログラミング規約(演算子) <a id="SS_19_5"></a>

### 19.5.1 演習-三項演算子 <a id="SS_19_5_1"></a>
* 問題
```cpp
...
* 参照 [三項演算子](programming_convention.md#SS_3_5_5)
* [解答例-三項演算子](exercise_a.md#SS_20_5_1)


### 19.5.2 演習-delete <a id="SS_19_5_2"></a>
* 問題
```cpp
...
* [解答例-delete](exercise_a.md#SS_20_5_2)


### 19.5.3 演習-sizeof <a id="SS_19_5_3"></a>
* 問題
```cpp
...
* [解答例-sizeof](exercise_a.md#SS_20_5_3)


### 19.5.4 演習-dynamic_castの削除 <a id="SS_19_5_4"></a>
* 問題
```cpp
...
* [解答例-dynamic_castの削除](exercise_a.md#SS_20_5_4)


### 19.5.5 演習-キャスト <a id="SS_19_5_5"></a>
* 問題  
...
* [解答-キャスト](exercise_a.md#SS_20_5_5)


## 19.6 プログラミング規約(スコープ) <a id="SS_19_6"></a>

### 19.6.1 演習-usingディレクティブ <a id="SS_19_6_1"></a>
* 問題  
...
* [解答-usingディレクティブ](exercise_a.md#SS_20_6_1)


## 19.7 プログラミング規約(その他) <a id="SS_19_7"></a>

### 19.7.1 演習-アサーションの選択 <a id="SS_19_7_1"></a>
* 問題  
...
* [解答-アサーションの選択](exercise_a.md#SS_20_7_1)


### 19.7.2 演習-assert/static_assert <a id="SS_19_7_2"></a>
* 問題
```cpp
...
* [解答例-assert/static_assert](exercise_a.md#SS_20_7_2)
...
### 19.8.1 演習-SRP <a id="SS_19_8_1"></a>
* 問題
```cpp
...
* [解答例-SRP](exercise_a.md#SS_20_8_1)


### 19.8.2 演習-OCP <a id="SS_19_8_2"></a>
* 問題
```cpp
...
* [解答例-OCP](exercise_a.md#SS_20_8_2)


### 19.8.3 演習-LSP <a id="SS_19_8_3"></a>
* 問題
```cpp
...
* [解答例-LSP](exercise_a.md#SS_20_8_3)


### 19.8.4 演習-ISP <a id="SS_19_8_4"></a>
* 問題
```cpp
...
* [解答例-ISP](exercise_a.md#SS_20_8_4)


### 19.8.5 演習-DIP <a id="SS_19_8_5"></a>
* 問題
```cpp
...
* [解答例-DIP](exercise_a.md#SS_20_8_5)


### 19.8.6 演習-SOLIDの定義 <a id="SS_19_8_6"></a>
* 問題  
  下記原則群と説明群を結びつけよ。
...
* [解答-SOLIDの定義](exercise_a.md#SS_20_8_6)


## 19.9 デザインパターン <a id="SS_19_9"></a>
### 19.9.1 演習-ガード節 <a id="SS_19_9_1"></a>
* 問題
```cpp
...
* [解答例-ガード節](exercise_a.md#SS_20_9_1)


### 19.9.2 演習-BitmaskType <a id="SS_19_9_2"></a>
* 問題
```cpp
...
* [解答例-BitmaskType](exercise_a.md#SS_20_9_2)


### 19.9.3 演習-Pimpl <a id="SS_19_9_3"></a>
* 問題
```cpp
...
* [解答例-Pimpl](exercise_a.md#SS_20_9_3)


### 19.9.4 演習-Accessorの副作用 <a id="SS_19_9_4"></a>
* 問題  
...
* [解答-Accessorの副作用](exercise_a.md#SS_20_9_4)


### 19.9.5 演習-Accessor <a id="SS_19_9_5"></a>
* 問題
```cpp
...
* 参照 [Accessor](design_pattern.md#SS_9_4)
* [解答例-Accessor](exercise_a.md#SS_20_9_5)


### 19.9.6 演習-Copy-And-Swap <a id="SS_19_9_6"></a>
* 問題
```cpp
...
* 参照 [Copy-And-Swap](design_pattern.md#SS_9_5)
* [解答例-Copy-And-Swap](exercise_a.md#SS_20_9_6)


### 19.9.7 演習-Immutable <a id="SS_19_9_7"></a>
* 問題
```cpp
...
* 参照 [Immutable](design_pattern.md#SS_9_6)
* [解答例-Immutable](exercise_a.md#SS_20_9_7)


### 19.9.8 演習-Clone <a id="SS_19_9_8"></a>
* 問題
```cpp
...
* 参照 [Clone(仮想コンストラクタ)](design_pattern.md#SS_9_7)
* [解答例-Clone](exercise_a.md#SS_20_9_8)


### 19.9.9 演習-NVI <a id="SS_19_9_9"></a>
* 問題
```cpp
...
* 参照 [NVI(non virtual interface)](design_pattern.md#SS_9_8)
* [解答例-NVI](exercise_a.md#SS_20_9_9)


### 19.9.10 演習-RAIIの効果 <a id="SS_19_9_10"></a>
* 問題  
...
* [解答-RAIIの効果](exercise_a.md#SS_20_9_10)


### 19.9.11 演習-RAII <a id="SS_19_9_11"></a>
* 問題
```cpp
...
* 参照 [RAII(scoped guard)](design_pattern.md#SS_9_9)
* [解答例-RAII](exercise_a.md#SS_20_9_11)


### 19.9.12 演習-Future <a id="SS_19_9_12"></a>
* 問題
```cpp
...
* 参照 [Future](design_pattern.md#SS_9_10)
* [解答例-Future](exercise_a.md#SS_20_9_12)


### 19.9.13 演習-DI <a id="SS_19_9_13"></a>
* 問題
```cpp
...
* 参照 [DI(dependency injection)](design_pattern.md#SS_9_11)
* [解答例-DI](exercise_a.md#SS_20_9_13)


### 19.9.14 演習-Singleton <a id="SS_19_9_14"></a>
* 問題
```cpp
...
* 参照 [Singleton](design_pattern.md#SS_9_12)
* [解答例-Singleton](exercise_a.md#SS_20_9_14)


### 19.9.15 演習-State <a id="SS_19_9_15"></a>
* 問題
```cpp
...
* 参照 [State](design_pattern.md#SS_9_13)
* [解答例-State](exercise_a.md#SS_20_9_15)


### 19.9.16 演習-Null Object <a id="SS_19_9_16"></a>
* 問題
```cpp
...
* 参照 [Null Object](design_pattern.md#SS_9_14)
* [解答例-Null Object](exercise_a.md#SS_20_9_16)


### 19.9.17 演習-Templateメソッド <a id="SS_19_9_17"></a>
* 問題
```cpp
...
* 参照 [Templateメソッド](design_pattern.md#SS_9_15)
* [解答例-Templateメソッド](exercise_a.md#SS_20_9_17)


### 19.9.18 演習-Factory <a id="SS_19_9_18"></a>
* 問題
```cpp
...
* 参照 [Factory](design_pattern.md#SS_9_16)
* [解答例-Factory](exercise_a.md#SS_20_9_18)


### 19.9.19 演習-Named Constructor <a id="SS_19_9_19"></a>
* 問題
```cpp
...
```
```cpp
    // @@@ exercise/design_pattern_q/named_constructor_lib.cpp 114
...
* 参照 [Named Constructor](design_pattern.md#SS_9_17)
* [解答例-Named Constructor](exercise_a.md#SS_20_9_19)


### 19.9.20 演習-Proxy <a id="SS_19_9_20"></a>
* 問題
```cpp
...
* 参照 [Proxy](design_pattern.md#SS_9_18)
* [解答例-Proxy](exercise_a.md#SS_20_9_20)


### 19.9.21 演習-Strategy <a id="SS_19_9_21"></a>
* 問題
```cpp
...
* 参照 [Strategy](design_pattern.md#SS_9_19)
* [解答例-Strategy](exercise_a.md#SS_20_9_21)


### 19.9.22 演習-Visitor <a id="SS_19_9_22"></a>
* 問題
```cpp
...
* 参照 [Visitor](design_pattern.md#SS_9_20)
* [解答例-Visitor](exercise_a.md#SS_20_9_22)


### 19.9.23 演習-CRTP <a id="SS_19_9_23"></a>
* 問題
```cpp
...
* 参照 [CRTP(curiously recurring template pattern)](design_pattern.md#SS_9_21)
* [解答例-CRTP](exercise_a.md#SS_20_9_23)


### 19.9.24 演習-Observer <a id="SS_19_9_24"></a>
* 問題
```cpp
...
* 参照 [Observer](design_pattern.md#SS_9_22)
* [解答例-Observer](exercise_a.md#SS_20_9_24)


### 19.9.25 演習-デザインパターン選択1 <a id="SS_19_9_25"></a>
* 問題  
  オブジェクトの状態と、
...
* [解答-デザインパターン選択1](exercise_a.md#SS_20_9_25)


### 19.9.26 演習-デザインパターン選択2 <a id="SS_19_9_26"></a>
* 問題  
...
* [解答-デザインパターン選択2](exercise_a.md#SS_20_9_26)


### 19.9.27 演習-デザインパターン選択3 <a id="SS_19_9_27"></a>
* 問題  
...
* [解答-デザインパターン選択3](exercise_a.md#SS_20_9_27)


## 19.10 開発プロセスとインフラ(全般) <a id="SS_19_10"></a>

### 19.10.1 演習-プロセス分類 <a id="SS_19_10_1"></a>
* 問題  
...
* [解答-プロセス分類](exercise_a.md#SS_20_10_1)


### 19.10.2 演習-V字モデル <a id="SS_19_10_2"></a>
* 問題  
...
* [解答-V字モデル](exercise_a.md#SS_20_10_2)


### 19.10.3 演習-アジャイル <a id="SS_19_10_3"></a>
* 問題  
...
* [解答-アジャイル](exercise_a.md#SS_20_10_3)


### 19.10.4 演習-自動化 <a id="SS_19_10_4"></a>
* 問題  
...
* [解答-自動化](exercise_a.md#SS_20_10_4)


### 19.10.5 演習-単体テスト <a id="SS_19_10_5"></a>
* 問題  
...
* [解答-単体テスト](exercise_a.md#SS_20_10_5)


### 19.10.6 演習-リファクタリングに付随する活動 <a id="SS_19_10_6"></a>
* 問題  
...
* [解答-リファクタリングに付随する活動](exercise_a.md#SS_20_10_6)


### 19.10.7 演習-リファクタリング対象コード <a id="SS_19_10_7"></a>
* 問題  
...
* [解答-リファクタリング対象コード](exercise_a.md#SS_20_10_7)


### 19.10.8 演習-CI <a id="SS_19_10_8"></a>
* 問題  
...
* [解答-CI](exercise_a.md#SS_20_10_8)


## 19.11 テンプレートメタプログラミング <a id="SS_19_11"></a>

### 19.11.1 演習-パラメータパック <a id="SS_19_11_1"></a>
* 問題
```cpp
...
* [解答例-パラメータパック](exercise_a.md#SS_20_11_1)


### 19.11.2 演習-エイリアステンプレート <a id="SS_19_11_2"></a>
* 問題
```cpp
...
* [解答例-エイリアステンプレート](exercise_a.md#SS_20_11_2)


### 19.11.3 演習-名前空間による修飾不要なoperator\<\< <a id="SS_19_11_3"></a>
* 問題
```cpp
...
* [解答例-名前空間による修飾不要なoperator\<\<](exercise_a.md#SS_20_11_3)


### 19.11.4 演習-std::arrayの継承 <a id="SS_19_11_4"></a>
* 問題
```cpp
...
* [解答例-std::arrayの継承](exercise_a.md#SS_20_11_4)


### 19.11.5 演習-SFINAEを利用しない関数テンプレートの特殊化によるis_void <a id="SS_19_11_5"></a>
* 問題
```cpp
...
* 参照 [is_void_fの実装](template_meta_programming.md#SS_13_3_2_1)
* [解答例-SFINAEを利用しない関数テンプレートの特殊化によるis_void](exercise_a.md#SS_20_11_5)


### 19.11.6 演習-SFINAEを利用しないクラステンプレートの特殊化によるis_void <a id="SS_19_11_6"></a>
* 問題
...
* 参照 [is_void_sの実装](template_meta_programming.md#SS_13_3_2_2)
* [解答例-SFINAEを利用しないクラステンプレートの特殊化によるis_void](exercise_a.md#SS_20_11_6)


### 19.11.7 演習-SFINAEを利用した関数テンプレートの特殊化によるis_void <a id="SS_19_11_7"></a>
* 問題
```cpp
...
* 参照 [is_void_sfinae_fの実装](template_meta_programming.md#SS_13_3_2_3)
* [解答例-SFINAEを利用した関数テンプレートの特殊化によるis_void](exercise_a.md#SS_20_11_7)


### 19.11.8 演習-SFINAEを利用したクラステンプレートの特殊化によるis_void <a id="SS_19_11_8"></a>
* 問題
```cpp
...
* 参照 [is_void_sfinae_sの実装](template_meta_programming.md#SS_13_3_2_4)
* [解答例-SFINAEを利用したクラステンプレートの特殊化によるis_void](exercise_a.md#SS_20_11_8)


### 19.11.9 演習-テンプレートテンプレートパラメータ <a id="SS_19_11_9"></a>
* 問題
```cpp
...
* 参照 [is_same_templの実装](template_meta_programming.md#SS_13_3_3_6)
* [解答例-テンプレートテンプレートパラメータ](exercise_a.md#SS_20_11_9)


### 19.11.10 演習-テンプレートパラメータを可変長にしたstd::is_same <a id="SS_19_11_10"></a>
* 問題
```cpp
...
* 参照 [IsSameSomeOfの実装](template_meta_programming.md#SS_13_3_3_7)
* [解答例-テンプレートパラメータを可変長にしたstd::is_same](exercise_a.md#SS_20_11_10)


### 19.11.11 演習-メンバ関数の存在の診断 <a id="SS_19_11_11"></a>
* 問題
```cpp
...
* [解答例-メンバ関数の存在の診断](exercise_a.md#SS_20_11_11)


### 19.11.12 演習-範囲for文のオペランドになれるかどうかの診断 <a id="SS_19_11_12"></a>
* 問題
```cpp
...
* 参照 [関数の存在の診断](template_meta_programming.md#SS_13_3_5)
* [解答例-範囲for文のオペランドになれるかどうかの診断](exercise_a.md#SS_20_11_12)


### 19.11.13 演習-配列の長さの取り出し <a id="SS_19_11_13"></a>
* 問題
```cpp
...
* 参照 [関数の存在の診断](template_meta_programming.md#SS_13_3_5)
* [解答例-配列の長さの取り出し](exercise_a.md#SS_20_11_13)


### 19.11.14 演習-配列の次元の取り出し <a id="SS_19_11_14"></a>
* 問題
```cpp
...
* 参照 [ValueTypeの実装](template_meta_programming.md#SS_13_3_5_9)
* [解答例-配列の次元の取り出し](exercise_a.md#SS_20_11_14)


### 19.11.15 演習-関数型のテンプレートパラメータを持つクラステンプレート <a id="SS_19_11_15"></a>
* 問題
```cpp
...
* 参照 [関数型をテンプレートパラメータで使う](template_meta_programming.md#SS_13_6_8)
* [解答例-関数型のテンプレートパラメータを持つクラステンプレート](exercise_a.md#SS_20_11_15)
