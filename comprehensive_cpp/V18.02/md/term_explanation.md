...
# 18 用語解説 <a id="SS_18"></a>

この章では、このドキュメントで使用する用語の解説をする。

## 18.1 型とインスタンス <a id="SS_18_1"></a>

### 18.1.1 算術型 <a id="SS_18_1_1"></a>
算術型とは下記の型の総称である。
...
### 18.1.7 標準レイアウト型 <a id="SS_18_1_7"></a>
標準レイアウト型とは、
...
### 18.1.8 トリビアル型 <a id="SS_18_1_8"></a>
トリビアル型とは、
...
### 18.1.9 underlying type <a id="SS_18_1_9"></a>
...
### 18.1.10 不完全型 <a id="SS_18_1_10"></a>
...
### 18.1.11 完全型 <a id="SS_18_1_11"></a>
[不完全型](term_explanation.md#SS_18_1_10)ではない型を指す。

### 18.1.12 ポリモーフィックなクラス <a id="SS_18_1_12"></a>
ポリモーフィックなクラスとは、仮想関数を持つクラスを指す。
なお、純粋仮想関数を持つクラスは、仮想クラスと呼ばれれる。

### 18.1.13 インターフェースクラス <a id="SS_18_1_13"></a>
...
### 18.1.14 constインスタンス <a id="SS_18_1_14"></a>

constインスタンスとはランタイムの初期化時に値が確定し、その後、状態が不変であるインスタンスである。

### 18.1.15 constexprインスタンスと関数 <a id="SS_18_1_15"></a>
...
### 18.1.16 ユーザ定義リテラル演算子 <a id="SS_18_1_16"></a>
...
### 18.1.17 std::string型リテラル <a id="SS_18_1_17"></a>
...
## 18.2 オブジェクトと生成 <a id="SS_18_2"></a>

### 18.2.1 特殊メンバ関数 <a id="SS_18_2_1"></a>
特殊メンバ関数とは下記の関数を指す。
...
### 18.2.2 初期化子リストコンストラクタ <a id="SS_18_2_2"></a>
...
### 18.2.3 継承コンストラクタ <a id="SS_18_2_3"></a>
...
### 18.2.4 委譲コンストラクタ <a id="SS_18_2_4"></a>
...
### 18.2.5 非explitなコンストラクタによる暗黙の型変換 <a id="SS_18_2_5"></a>
...
### 18.2.8 AAAスタイル <a id="SS_18_2_8"></a>
...
### 18.2.9 オブジェクトの所有権 <a id="SS_18_2_9"></a>
...
#### 18.2.9.1 オブジェクトの排他所有 <a id="SS_18_2_9_1"></a>
...
#### 18.2.9.2 オブジェクトの共有所有 <a id="SS_18_2_9_2"></a>
...
### 18.2.10 オブジェクトのライフタイム <a id="SS_18_2_10"></a>
...
### 18.2.11 クラスのレイアウト <a id="SS_18_2_11"></a>
...
## 18.3 オブジェクトのコピー <a id="SS_18_3"></a>

### 18.3.1 シャローコピー <a id="SS_18_3_1"></a>
...
### 18.3.2 ディープコピー <a id="SS_18_3_2"></a>
...
### 18.3.3 スライシング <a id="SS_18_3_3"></a>
オブジェクトのスライシングとは、
...
## 18.4 name lookupと名前空間 <a id="SS_18_4"></a>
ここではname lookupとそれに影響を与える名前空間について解説する。

### 18.4.1 ルックアップ <a id="SS_18_4_1"></a>
このドキュメントでのルックアップとは[name lookup](term_explanation.md#SS_18_4_2)を指す。

### 18.4.2 name lookup <a id="SS_18_4_2"></a>
...
### 18.4.3 two phase name lookup <a id="SS_18_4_3"></a>
...
### 18.4.8 name-hiding <a id="SS_18_4_8"></a>
name-hidingとは
...
#### 18.4.9.1 ダイヤモンド継承を含まない場合 <a id="SS_18_4_9_1"></a>
...
#### 18.4.9.2 ダイヤモンド継承かつそれが仮想継承でない場合 <a id="SS_18_4_9_2"></a>
...
#### 18.4.9.3 ダイヤモンド継承かつそれが仮想継承である場合 <a id="SS_18_4_9_3"></a>
...
### 18.4.10 ダイヤモンド継承 <a id="SS_18_4_10"></a>
...
### 18.4.11 仮想継承 <a id="SS_18_4_11"></a>
...
### 18.4.12 仮想基底 <a id="SS_18_4_12"></a>
仮想基底(クラス)とは、[仮想継承](term_explanation.md#SS_18_4_11)の基底クラス指す。

### 18.4.13 using宣言 <a id="SS_18_4_13"></a>
...
### 18.4.14 usingディレクティブ <a id="SS_18_4_14"></a>
...
## 18.5 expressionと値カテゴリ <a id="SS_18_5"></a>
ここでは、expression(式)の値カテゴリや、それに付随した機能についての解説を行う。

### 18.5.1 expression <a id="SS_18_5_1"></a>
...
### 18.5.2 lvalue <a id="SS_18_5_2"></a>
「[expression](term_explanation.md#SS_18_5_1)」を参照せよ。

### 18.5.3 rvalue <a id="SS_18_5_3"></a>
「[expression](term_explanation.md#SS_18_5_1)」を参照せよ。

#### 18.5.3.1 xvalue <a id="SS_18_5_3_1"></a>
「[expression](term_explanation.md#SS_18_5_1)」を参照せよ。

#### 18.5.3.2 prvalue <a id="SS_18_5_3_2"></a>
「[expression](term_explanation.md#SS_18_5_1)」を参照せよ。

### 18.5.4 rvalue修飾 <a id="SS_18_5_4"></a>
...
### 18.6.1 ユニバーサルリファレンス <a id="SS_18_6_1"></a>
...
### 18.6.2 forwardingリファレンス <a id="SS_18_6_2"></a>
「[ユニバーサルリファレンス](term_explanation.md#SS_18_6_1)」を参照せよ。

### 18.6.3 perfect forwarding <a id="SS_18_6_3"></a>
...
### 18.6.4 リファレンスcollapsing <a id="SS_18_6_4"></a>
...
### 18.6.5 danglingリファレンス <a id="SS_18_6_5"></a>
...
### 18.8.1 等価性のセマンティクス <a id="SS_18_8_1"></a>
...
### 18.8.2 copyセマンティクス <a id="SS_18_8_2"></a>
...
### 18.8.3 moveセマンティクス <a id="SS_18_8_3"></a>
...
## 18.9 C++コンパイラ <a id="SS_18_9"></a>
本ドキュメントで使用するg++/clang++のバージョンは以下のとおりである。

### 18.9.1 g++ <a id="SS_18_9_1"></a>
```
...
## 18.10 C++その他 <a id="SS_18_10"></a>
### 18.10.1 オーバーライドとオーバーロードの違い <a id="SS_18_10_1"></a>
...
### 18.10.2 実引数/仮引数 <a id="SS_18_10_2"></a>
...
### 18.10.3 範囲for文 <a id="SS_18_10_3"></a>
...
### 18.10.4 ラムダ式 <a id="SS_18_10_4"></a>
ラムダ式に関する言葉の定義と例を示す。
...
### 18.10.5 ジェネリックラムダ <a id="SS_18_10_5"></a>
...
### 18.10.6 関数tryブロック <a id="SS_18_10_6"></a>
...
### 18.10.7 単純代入 <a id="SS_18_10_7"></a>
代入は下記のように分類される。

* 単純代入(=)
* 複合代入(+=，++ 等)

### 18.10.8 ill-formed <a id="SS_18_10_8"></a>
...
### 18.10.9 well-formed <a id="SS_18_10_9"></a>
「[ill-formed](term_explanation.md#SS_18_10_8)」を参照せよ。

### 18.10.10 one-definition rule <a id="SS_18_10_10"></a>
「[ODR](term_explanation.md#SS_18_10_11)」を参照せよ。

### 18.10.11 ODR <a id="SS_18_10_11"></a>
...
### 18.10.12 RVO(Return Value Optimization) <a id="SS_18_10_12"></a>
関数の戻り値がオブジェクトである場合、
...
### 18.10.13 SSO(Small String Optimization) <a id="SS_18_10_13"></a>
...
### 18.10.14 Most Vexing Parse <a id="SS_18_10_14"></a>
...
### 18.10.15 RTTI <a id="SS_18_10_15"></a>
...
### 18.10.16 Run-time Type Information <a id="SS_18_10_16"></a>
「[RTTI](term_explanation.md#SS_18_10_15)」を参照せよ。

### 18.10.17 simple-declaration <a id="SS_18_10_17"></a>
このための記述が
...
### 18.10.18 typeid <a id="SS_18_10_18"></a>
「[RTTI](term_explanation.md#SS_18_10_15)」を参照せよ。

### 18.10.19 トライグラフ <a id="SS_18_10_19"></a>
...
### 18.10.20 フリースタンディング環境 <a id="SS_18_10_20"></a>
...
## 18.11 ソフトウェア一般 <a id="SS_18_11"></a>
### 18.11.1 凝集度 <a id="SS_18_11_1"></a>
...
### 18.11.2 サイクロマティック複雑度 <a id="SS_18_11_2"></a>
...
### 18.11.3 Spurious Wakeup <a id="SS_18_11_3"></a>
...
### 18.11.5 is-a <a id="SS_18_11_5"></a>
...
### 18.11.6 has-a <a id="SS_18_11_6"></a>
「has-a」の関係は、
...
### 18.11.7 is-implemented-in-terms-of <a id="SS_18_11_7"></a>
...
#### 18.11.7.1 public継承によるis-implemented-in-terms-of <a id="SS_18_11_7_1"></a>
...
#### 18.11.7.2 private継承によるis-implemented-in-terms-of <a id="SS_18_11_7_2"></a>
...
#### 18.11.7.3 コンポジションによる(has-a)is-implemented-in-terms-of <a id="SS_18_11_7_3"></a>
...
## 18.12 非ソフトウェア用語 <a id="SS_18_12"></a>
### 18.12.1 割れ窓理論 <a id="SS_18_12_1"></a>
...
### 18.12.2 車輪の再発明 <a id="SS_18_12_2"></a>
