...
# 14 ダイナミックメモリアロケーション <a id="SS_14"></a>
...
## 14.1 malloc/freeの問題点 <a id="SS_14_1"></a>
...
## 14.2 グローバルnew/deleteのオーバーロード <a id="SS_14_2"></a>
...
### 14.2.1 固定長メモリプール <a id="SS_14_2_1"></a>
...
### 14.2.2 グローバルnew/deleteのオーバーロードの実装 <a id="SS_14_2_2"></a>
...
### 14.2.3 プレースメントnew <a id="SS_14_2_3"></a>
...
### 14.2.4 デバッグ用イテレータ <a id="SS_14_2_4"></a>
...
## 14.3 クラスnew/deleteのオーバーロード <a id="SS_14_3"></a>
...
## 14.4 STLコンテナのアロケーター <a id="SS_14_4"></a>
...
### 14.4.1 STLコンテナ用アロケータ <a id="SS_14_4_1"></a>
アロケータの定義例を以下に示す。
...
### 14.4.2 可変長メモリプール <a id="SS_14_4_2"></a>
...
### 14.4.3 デバッグ用イテレータ <a id="SS_14_4_3"></a>
...
### 14.4.4 エクセプション処理機構の変更 <a id="SS_14_4_4"></a>
