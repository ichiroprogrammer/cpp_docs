...
* 参照 [インスタンスの初期化](programming_convention.md#SS_3_1_12)、[一様初期化](term_explanation.md#SS_19_5_6)
...
* 問題
```cpp
    // @@@ exercise/programming_convention_q/syntax.cpp 35
    // [Q]
...
* 問題
```cpp
    // @@@ exercise/programming_convention_q/syntax.cpp 51
    // [Q]
...
### 演習-名前空間による修飾不要なoperator\<\< <a id="SS_20_11_3"></a>
* 問題
```cpp
...
* [解答例-名前空間による修飾不要なoperator\<\<](exercise_a.md#SS_21_11_3)
