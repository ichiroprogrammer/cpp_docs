...
* copy代入演算子には、[エクセプション安全性の保証](term_explanation.md#SS_19_15)がない。
...
これにより[エクセプション安全性の保証](term_explanation.md#SS_19_15)を持つ4関数をコードクローンすることなく実装できる。
...
* クラスの理解が曖昧なC++プログラマの理解を助ける(「[クラスのレイアウト](term_explanation.md#SS_19_3_8)」参照)
