...
[フリースタンディング環境](term_explanation.md#SS_19_19_1)では、sbrkのようなシステムコールは存在しないため、
...
* 複数個のメモリプールを統合的に扱う[インターフェースクラス](term_explanation.md#SS_19_3_11)MPool
...
[一様初期化](term_explanation.md#SS_19_5_6)で行った方が良いが、
...
コンパイラに[g++](term_explanation.md#SS_19_18_1)や[clang++](term_explanation.md#SS_19_18_2)を使っている場合、
