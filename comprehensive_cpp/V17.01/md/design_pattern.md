...
## 9.5 Copy-And-Swap <a id="SS_9_5"></a>
...
## 9.7 Clone(仮想コンストラクタ) <a id="SS_9_7"></a>
...
## 9.8 NVI(non virtual interface) <a id="SS_9_8"></a>
...
## 9.9 RAII(scoped guard) <a id="SS_9_9"></a>
...
## 9.11 DI(dependency injection) <a id="SS_9_11"></a>
...
## 9.14 Null Object <a id="SS_9_14"></a>
...
## 9.15 Templateメソッド <a id="SS_9_15"></a>
...
## 9.17 Named Constructor <a id="SS_9_17"></a>
...
## 9.21 CRTP(curiously recurring template pattern) <a id="SS_9_21"></a>
CRTPとは、
