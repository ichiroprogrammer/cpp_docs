...
### 15.3.1 ビルド時間の短縮 <a id="SS_15_3_1"></a>
...
### 15.3.2 依存関係の整理 <a id="SS_15_3_2"></a>
...
## 15.4 自動単体テストの実施 <a id="SS_15_4"></a>
...
## 15.5 自動統合テストの実施 <a id="SS_15_5"></a>
...
```cpp
    // @@@ example/deps/logging/h/logger.h 10
...
```cpp
    // @@@ example/deps/app/src/main.cpp 44
...
#### 15.6.2.1 メモリ保護機能 <a id="SS_15_6_2_1"></a>
組み込みソフトは、仮想アドレスを使わず、
...
#### 15.6.2.2 スタック消費量の計測 <a id="SS_15_6_2_2"></a>
...
### 15.9.1 現象1 - 不思議なハングアップ <a id="SS_15_9_1"></a>
...
### 15.9.2 現象2 - グローバル変数の破壊 <a id="SS_15_9_2"></a>
...
### 15.9.3 現象3 - プロセスのスローダウン <a id="SS_15_9_3"></a>
...
### 15.9.4 現象4 - バックトレースが見れない <a id="SS_15_9_4"></a>
...
### 15.9.5 現象5 - newしたオブジェクトの破壊 <a id="SS_15_9_5"></a>
...
### 15.9.6 現象6 - STLのバグ? <a id="SS_15_9_6"></a>
あるプロジェクトの朝会でのこと。
...
### 15.9.7 現象7 - 解放後のrvalueへのアクセス <a id="SS_15_9_7"></a>
下記の関数gen_strは、
