...
## 20.1 プログラミング規約(型) <a id="SS_20_1"></a>

### 20.1.1 解答-汎整数型の選択 <a id="SS_20_1_1"></a>
* 選択肢3
...
* [演習-汎整数型の選択](exercise_q.md#SS_19_1_1)へ戻る。


### 20.1.2 解答例-汎整数型の演算 <a id="SS_20_1_2"></a>
```cpp
...
* [演習-汎整数型の演算](exercise_q.md#SS_19_1_2)へ戻る。


### 20.1.3 解答例-浮動小数点型 <a id="SS_20_1_3"></a>
```cpp
...
* [演習-浮動小数点型](exercise_q.md#SS_19_1_3)へ戻る。


### 20.1.4 解答-定数列挙 <a id="SS_20_1_4"></a>
* 選択肢4
* 参照 [enum](programming_convention.md#SS_3_1_2)
* [演習-定数列挙](exercise_q.md#SS_19_1_4)へ戻る。


### 20.1.5 解答例-enum <a id="SS_20_1_5"></a>
```cpp
...
* [演習-enum](exercise_q.md#SS_19_1_5)へ戻る。


### 20.1.6 解答例-配列の範囲for文 <a id="SS_20_1_6"></a>
```cpp
...
* [演習-配列の範囲for文](exercise_q.md#SS_19_1_6)へ戻る。


### 20.1.7 解答例-エイリアス <a id="SS_20_1_7"></a>
```cpp
...
* [演習-エイリアス](exercise_q.md#SS_19_1_7)へ戻る。


### 20.1.8 解答-constの意味 <a id="SS_20_1_8"></a>
* 選択肢1
* 参照 [const/constexprインスタンス](programming_convention.md#SS_3_1_9)
* [演習-constの意味](exercise_q.md#SS_19_1_8)へ戻る。


### 20.1.9 解答例-const/constexpr <a id="SS_20_1_9"></a>
```cpp
...
* [演習-const/constexpr](exercise_q.md#SS_19_1_9)へ戻る。


### 20.1.10 解答例-危険なconst_cast <a id="SS_20_1_10"></a>
```cpp
...
* [演習-危険なconst_cast](exercise_q.md#SS_19_1_10)へ戻る。


### 20.1.11 解答例-リテラル <a id="SS_20_1_11"></a>
```cpp
...
* [演習-リテラル](exercise_q.md#SS_19_1_11)へ戻る。


### 20.1.12 解答-適切なautoの使い方 <a id="SS_20_1_12"></a>
* 選択肢4
* 参照 [auto](programming_convention.md#SS_3_1_11_1)
* [演習-適切なautoの使い方](exercise_q.md#SS_19_1_12)へ戻る。


### 20.1.13 解答-ポインタの初期化 <a id="SS_20_1_13"></a>
* 選択肢3
* 参照 [リテラル](programming_convention.md#SS_3_1_10)
* [演習-ポインタの初期化](exercise_q.md#SS_19_1_13)へ戻る。


### 20.1.14 解答-vector初期化 <a id="SS_20_1_14"></a>
* 選択肢1
* 参照 [インスタンスの初期化](programming_convention.md#SS_3_1_12)
* [演習-vector初期化](exercise_q.md#SS_19_1_14)へ戻る。


### 20.1.15 解答例-インスタンスの初期化 <a id="SS_20_1_15"></a>
```cpp
...
* [演習-インスタンスの初期化](exercise_q.md#SS_19_1_15)へ戻る。


## 20.2 プログラミング規約(クラス) <a id="SS_20_2"></a>

### 20.2.1 解答-凝集度の意味 <a id="SS_20_2_1"></a>
* 選択肢4
* 参照 [凝集度](programming_convention.md#SS_3_2_2_3)
* [演習-凝集度の意味](exercise_q.md#SS_19_2_1)へ戻る。


### 20.2.2 解答例-凝集度の向上 <a id="SS_20_2_2"></a>
```cpp
...
* [演習-凝集度の向上](exercise_q.md#SS_19_2_2)へ戻る。


### 20.2.3 解答-メンバ変数の初期化方法の選択 <a id="SS_20_2_3"></a>
* 選択肢2
* 参照 [非静的なメンバ変数/定数の初期化](programming_convention.md#SS_3_2_5)
* [演習-メンバ変数の初期化方法の選択](exercise_q.md#SS_19_2_3)へ戻る。


### 20.2.4 解答-メンバの型 <a id="SS_20_2_4"></a>
* 選択肢3
* 参照 [インスタンスの初期化](programming_convention.md#SS_3_1_12)
* 解説  
  関数の宣言と、クラスのデフォルトコンストラクタ呼び出しによるオブジェクトの生成は、
  プログラマを混乱させることがあるので注意が必要である。
* [演習-メンバの型](exercise_q.md#SS_19_2_4)へ戻る。


### 20.2.5 解答例-メンバ変数の初期化 <a id="SS_20_2_5"></a>
```cpp
...
* [演習-メンバ変数の初期化](exercise_q.md#SS_19_2_5)へ戻る。


### 20.2.6 解答例-スライシング <a id="SS_20_2_6"></a>
```cpp
...
* [演習-スライシング](exercise_q.md#SS_19_2_6)へ戻る。


### 20.2.7 解答例-オブジェクトの所有権 <a id="SS_20_2_7"></a>
```cpp
...
* [演習-オブジェクトの所有権](exercise_q.md#SS_19_2_7)へ戻る。


## 20.3 プログラミング規約(関数) <a id="SS_20_3"></a>
### 20.3.1 解答例-非メンバ関数の宣言 <a id="SS_20_3_1"></a>
```cpp
...
* [演習-非メンバ関数の宣言](exercise_q.md#SS_19_3_1)へ戻る。


### 20.3.2 解答例-メンバ関数の修飾 <a id="SS_20_3_2"></a>
```cpp
...
* [演習-メンバ関数の修飾](exercise_q.md#SS_19_3_2)へ戻る。


### 20.3.3 解答例-特殊メンバ関数の削除 <a id="SS_20_3_3"></a>
```cpp
...
* [演習-特殊メンバ関数の削除](exercise_q.md#SS_19_3_3)へ戻る。


### 20.3.4 解答例-委譲コンストラクタ <a id="SS_20_3_4"></a>
```cpp
...
* [演習-委譲コンストラクタ](exercise_q.md#SS_19_3_4)へ戻る。


### 20.3.5 解答例-copyコンストラクタ <a id="SS_20_3_5"></a>
```cpp
...
* [演習-copyコンストラクタ](exercise_q.md#SS_19_3_5)へ戻る。


### 20.3.6 解答例-moveコンストラクタ <a id="SS_20_3_6"></a>
```cpp
...
* [演習-moveコンストラクタ](exercise_q.md#SS_19_3_6)へ戻る。


### 20.3.7 解答例-関数分割 <a id="SS_20_3_7"></a>
```cpp
...
* [演習-関数分割](exercise_q.md#SS_19_3_7)へ戻る。


### 20.3.8 解答-オーバーライド関数の修飾 <a id="SS_20_3_8"></a>
* 選択肢2
* 参照 [オーバーライド](programming_convention.md#SS_3_3_2_7)
* [演習-オーバーライド関数の修飾](exercise_q.md#SS_19_3_8)へ戻る。


### 20.3.9 解答例-オーバーライド/オーバーロード <a id="SS_20_3_9"></a>
```cpp
...
* [演習-オーバーライド/オーバーロード](exercise_q.md#SS_19_3_9)へ戻る。


### 20.3.10 解答例-オーバーロードによる誤用防止 <a id="SS_20_3_10"></a>
```cpp
...
* [演習-オーバーロードによる誤用防止](exercise_q.md#SS_19_3_10)へ戻る。


### 20.3.11 解答例-仮引数の修飾 <a id="SS_20_3_11"></a>
```cpp
...
* [演習-仮引数の修飾](exercise_q.md#SS_19_3_11)へ戻る。


### 20.3.12 解答例-constexpr関数 <a id="SS_20_3_12"></a>
```cpp
...
* [演習-constexpr関数](exercise_q.md#SS_19_3_12)へ戻る。


### 20.3.13 解答-エクセプションの型 <a id="SS_20_3_13"></a>
* 選択肢2
...
* [演習-エクセプションの型](exercise_q.md#SS_19_3_13)へ戻る。


## 20.4 プログラミング規約(構文) <a id="SS_20_4"></a>

### 20.4.1 解答例-コンテナの範囲for文 <a id="SS_20_4_1"></a>
```cpp
...
* [演習-コンテナの範囲for文](exercise_q.md#SS_19_4_1)へ戻る。


### 20.4.2 解答例-ラムダ式 <a id="SS_20_4_2"></a>
```cpp
...
* [演習-ラムダ式](exercise_q.md#SS_19_4_2)へ戻る。


### 20.4.3 解答例-ラムダ式のキャプチャ <a id="SS_20_4_3"></a>
```cpp
...
* [演習-ラムダ式のキャプチャ](exercise_q.md#SS_19_4_3)へ戻る。


## 20.5 プログラミング規約(演算子) <a id="SS_20_5"></a>

### 20.5.1 解答例-三項演算子 <a id="SS_20_5_1"></a>
```cpp
...
* [演習-三項演算子](exercise_q.md#SS_19_5_1)へ戻る。

### 20.5.2 解答例-delete <a id="SS_20_5_2"></a>
```cpp
...
* [演習-delete](exercise_q.md#SS_19_5_2)へ戻る。

### 20.5.3 解答例-sizeof <a id="SS_20_5_3"></a>
```cpp
...
* [演習-sizeof](exercise_q.md#SS_19_5_3)へ戻る。


### 20.5.4 解答例-dynamic_castの削除 <a id="SS_20_5_4"></a>
```cpp
...
* [演習-dynamic_castの削除](exercise_q.md#SS_19_5_4)へ戻る。


### 20.5.5 解答-キャスト <a id="SS_20_5_5"></a>
* 選択肢3  
* 参照 [キャスト、暗黙の型変換](programming_convention.md#SS_3_5_10)
* 解説  
  reinterpret_castも避けるべきであるが、組み込みソフト等でのハードウエアアドレスの記述等には、
  使わざるを得ない。
* [演習-キャスト](exercise_q.md#SS_19_5_5)へ戻る。


## 20.6 プログラミング規約(スコープ) <a id="SS_20_6"></a>

### 20.6.1 解答-usingディレクティブ <a id="SS_20_6_1"></a>
* 選択肢1
* 参照 [using宣言/usingディレクティブ](programming_convention.md#SS_3_8_3)
* [演習-usingディレクティブ](exercise_q.md#SS_19_6_1)へ戻る。


## 20.7 プログラミング規約(その他) <a id="SS_20_7"></a>

### 20.7.1 解答-アサーションの選択 <a id="SS_20_7_1"></a>
* 選択肢1
* 参照 [assertion](programming_convention.md#SS_3_11_1)
* [演習-アサーションの選択](exercise_q.md#SS_19_7_1)へ戻る。


### 20.7.2 解答例-assert/static_assert <a id="SS_20_7_2"></a>
```cpp
...
* [演習-assert/static_assert](exercise_q.md#SS_19_7_2)へ戻る。


## 20.8 SOLID <a id="SS_20_8"></a>
### 20.8.1 解答例-SRP <a id="SS_20_8_1"></a>
```cpp
...
* [演習-SRP](exercise_q.md#SS_19_8_1)へ戻る。


### 20.8.2 解答例-OCP <a id="SS_20_8_2"></a>
```cpp
...
* [演習-OCP](exercise_q.md#SS_19_8_2)へ戻る。


### 20.8.3 解答例-LSP <a id="SS_20_8_3"></a>
```cpp
...
* [演習-LSP](exercise_q.md#SS_19_8_3)へ戻る。


### 20.8.4 解答例-ISP <a id="SS_20_8_4"></a>
```cpp
...
* [演習-ISP](exercise_q.md#SS_19_8_4)へ戻る。


### 20.8.5 解答例-DIP <a id="SS_20_8_5"></a>
```cpp
...
* [演習-DIP](exercise_q.md#SS_19_8_5)へ戻る。


### 20.8.6 解答-SOLIDの定義 <a id="SS_20_8_6"></a>
* 選択肢対応
    * SRP - 1
    * OCP - 2
    * LIP - 3
...
* [演習-SOLIDの定義](exercise_q.md#SS_19_8_6)へ戻る。


## 20.9 デザインパターン <a id="SS_20_9"></a>
### 20.9.1 解答例-ガード節 <a id="SS_20_9_1"></a>
```cpp
...
* [演習-ガード節](exercise_q.md#SS_19_9_1)へ戻る。


### 20.9.2 解答例-BitmaskType <a id="SS_20_9_2"></a>
```cpp
...
* [演習-BitmaskType](exercise_q.md#SS_19_9_2)へ戻る。


### 20.9.3 解答例-Pimpl <a id="SS_20_9_3"></a>
```cpp
...
* [演習-Pimpl](exercise_q.md#SS_19_9_3)へ戻る。


### 20.9.4 解答-Accessorの副作用 <a id="SS_20_9_4"></a>
* 選択肢1
* 参照 [Accessor](design_pattern.md#SS_9_4)
* [演習-Accessorの副作用](exercise_q.md#SS_19_9_4)へ戻る。


### 20.9.5 解答例-Accessor <a id="SS_20_9_5"></a>
```cpp
...
* [演習-Accessor](exercise_q.md#SS_19_9_5)へ戻る。


### 20.9.6 解答例-Copy-And-Swap <a id="SS_20_9_6"></a>
```cpp
...
* [演習-Copy-And-Swap](exercise_q.md#SS_19_9_6)へ戻る。


### 20.9.7 解答例-Immutable <a id="SS_20_9_7"></a>
```cpp
...
* [演習-Immutable](exercise_q.md#SS_19_9_7)へ戻る。


### 20.9.8 解答例-Clone <a id="SS_20_9_8"></a>
```cpp
...
* [演習-Clone](exercise_q.md#SS_19_9_8)へ戻る。


### 20.9.9 解答例-NVI <a id="SS_20_9_9"></a>
```cpp
...
* [演習-NVI](exercise_q.md#SS_19_9_9)へ戻る。


### 20.9.10 解答-RAIIの効果 <a id="SS_20_9_10"></a>
* 選択肢1
* 参照 [RAII(scoped guard)](design_pattern.md#SS_9_9)
* [演習-RAIIの効果](exercise_q.md#SS_19_9_10)へ戻る。


### 20.9.11 解答例-RAII <a id="SS_20_9_11"></a>
```cpp
...
* [演習-RAII](exercise_q.md#SS_19_9_11)へ戻る。


### 20.9.12 解答例-Future <a id="SS_20_9_12"></a>
```cpp
...
* [演習-Future](exercise_q.md#SS_19_9_12)へ戻る。


### 20.9.13 解答例-DI <a id="SS_20_9_13"></a>
```cpp
...
* [演習-DI](exercise_q.md#SS_19_9_13)へ戻る。


### 20.9.14 解答例-Singleton <a id="SS_20_9_14"></a>
```cpp
...
* [演習-Singleton](exercise_q.md#SS_19_9_14)へ戻る。


### 20.9.15 解答例-State <a id="SS_20_9_15"></a>
```cpp
...
* [演習-State](exercise_q.md#SS_19_9_15)へ戻る。


### 20.9.16 解答例-Null Object <a id="SS_20_9_16"></a>
```cpp
...
* [演習-Null Object](exercise_q.md#SS_19_9_16)へ戻る。


### 20.9.17 解答例-Templateメソッド <a id="SS_20_9_17"></a>
```cpp
...
* [演習-Templateメソッド](exercise_q.md#SS_19_9_17)へ戻る。


### 20.9.18 解答例-Factory <a id="SS_20_9_18"></a>
```cpp
...
* [演習-Factory](exercise_q.md#SS_19_9_18)へ戻る。


### 20.9.19 解答例-Named Constructor <a id="SS_20_9_19"></a>
```cpp
...
* [演習-Named Constructor](exercise_q.md#SS_19_9_19)へ戻る。


### 20.9.20 解答例-Proxy <a id="SS_20_9_20"></a>
```cpp
...
* [演習-Proxy](exercise_q.md#SS_19_9_20)へ戻る。


### 20.9.21 解答例-Strategy <a id="SS_20_9_21"></a>
```cpp
...
* [演習-Strategy](exercise_q.md#SS_19_9_21)へ戻る。


### 20.9.22 解答例-Visitor <a id="SS_20_9_22"></a>
```cpp
...
* [演習-Visitor](exercise_q.md#SS_19_9_22)へ戻る。


### 20.9.23 解答例-CRTP <a id="SS_20_9_23"></a>
```cpp
...
* [演習-CRTP](exercise_q.md#SS_19_9_23)へ戻る。


### 20.9.24 解答例-Observer <a id="SS_20_9_24"></a>
```cpp
...
* [演習-Observer](exercise_q.md#SS_19_9_24)へ戻る。


### 20.9.25 解答-デザインパターン選択1 <a id="SS_20_9_25"></a>
* 選択肢2
* 参照 [State](design_pattern.md#SS_9_13)
* [演習-デザインパターン選択1](exercise_q.md#SS_19_9_25)へ戻る。


### 20.9.26 解答-デザインパターン選択2 <a id="SS_20_9_26"></a>
* 選択肢4
* 参照 [Null Object](design_pattern.md#SS_9_14)
* [演習-デザインパターン選択2](exercise_q.md#SS_19_9_26)へ戻る。


### 20.9.27 解答-デザインパターン選択3 <a id="SS_20_9_27"></a>
* 選択肢3
* 参照 [Observer](design_pattern.md#SS_9_22)
* [演習-デザインパターン選択3](exercise_q.md#SS_19_9_27)へ戻る。


## 20.10 開発プロセスとインフラ(全般) <a id="SS_20_10"></a>

### 20.10.1 解答-プロセス分類 <a id="SS_20_10_1"></a>
* 選択肢対応
    * A - 1
    * B - 2
    * C - 3
...
* [演習-プロセス分類](exercise_q.md#SS_19_10_1)へ戻る。


### 20.10.2 解答-V字モデル <a id="SS_20_10_2"></a>
* 選択肢対応
    * フェーズA - 4
    * フェーズB - 2
    * フェーズC - 3
...
* [演習-V字モデル](exercise_q.md#SS_19_10_2)へ戻る。


### 20.10.3 解答-アジャイル <a id="SS_20_10_3"></a>
* 選択肢2
* 参照 [アジャイル系プロセス](process_and_infra.md#SS_11_1_2)
* [演習-アジャイル](exercise_q.md#SS_19_10_3)へ戻る。


### 20.10.4 解答-自動化 <a id="SS_20_10_4"></a>
* 選択肢対応
    * A - 1
    * B - 4
    * C - 5
...
* [演習-自動化](exercise_q.md#SS_19_10_4)へ戻る。


### 20.10.5 解答-単体テスト <a id="SS_20_10_5"></a>
* 選択肢4
* 参照 [自動単体テスト](process_and_infra.md#SS_11_2_1)
* [演習-単体テスト](exercise_q.md#SS_19_10_5)へ戻る。


### 20.10.6 解答-リファクタリングに付随する活動 <a id="SS_20_10_6"></a>
* 選択肢2
* 参照 [リファクタリング](process_and_infra.md#SS_11_2_2)
* [演習-リファクタリングに付随する活動](exercise_q.md#SS_19_10_6)へ戻る。


### 20.10.7 解答-リファクタリング対象コード <a id="SS_20_10_7"></a>
* 選択肢3
* 参照 [リファクタリング](process_and_infra.md#SS_11_2_2)
* [演習-リファクタリング対象コード](exercise_q.md#SS_19_10_7)へ戻る。


### 20.10.8 解答-CI <a id="SS_20_10_8"></a>
* 選択肢2, 4
* 参照 [CI(継続的インテグレーション)](process_and_infra.md#SS_11_2_5)
* [演習-CI](exercise_q.md#SS_19_10_8)へ戻る。


## 20.11 テンプレートメタプログラミング <a id="SS_20_11"></a>
### 20.11.1 解答例-パラメータパック <a id="SS_20_11_1"></a>
```cpp
...
* [演習-パラメータパック](exercise_q.md#SS_19_11_1)へ戻る。


### 20.11.2 解答例-エイリアステンプレート <a id="SS_20_11_2"></a>
```cpp
...
* [演習-エイリアステンプレート](exercise_q.md#SS_19_11_2)へ戻る。


### 20.11.3 解答例-名前空間による修飾不要なoperator\<\< <a id="SS_20_11_3"></a>
```cpp
...
* [演習-名前空間による修飾不要なoperator\<\<](exercise_q.md#SS_19_11_3)へ戻る。


### 20.11.4 解答例-std::arrayの継承 <a id="SS_20_11_4"></a>
```cpp
...
* [演習-std::arrayの継承](exercise_q.md#SS_19_11_4)へ戻る。


### 20.11.5 解答例-SFINAEを利用しない関数テンプレートの特殊化によるis_void <a id="SS_20_11_5"></a>
```cpp
...
* [演習-SFINAEを利用しない関数テンプレートの特殊化によるis_void](exercise_q.md#SS_19_11_5)へ戻る。


### 20.11.6 解答例-SFINAEを利用しないクラステンプレートの特殊化によるis_void <a id="SS_20_11_6"></a>
```cpp
...
* [演習-SFINAEを利用しないクラステンプレートの特殊化によるis_void](exercise_q.md#SS_19_11_6)へ戻る。


### 20.11.7 解答例-SFINAEを利用した関数テンプレートの特殊化によるis_void <a id="SS_20_11_7"></a>
```cpp
...
* [演習-SFINAEを利用した関数テンプレートの特殊化によるis_void](exercise_q.md#SS_19_11_7)へ戻る。


### 20.11.8 解答例-SFINAEを利用したクラステンプレートの特殊化によるis_void <a id="SS_20_11_8"></a>
```cpp
...
* [演習-SFINAEを利用したクラステンプレートの特殊化によるis_void](exercise_q.md#SS_19_11_8)へ戻る。


### 20.11.9 解答例-テンプレートテンプレートパラメータ <a id="SS_20_11_9"></a>
```cpp
...
* [演習-テンプレートテンプレートパラメータ](exercise_q.md#SS_19_11_9)へ戻る。


### 20.11.10 解答例-テンプレートパラメータを可変長にしたstd::is_same <a id="SS_20_11_10"></a>
```cpp
...
* [演習-テンプレートパラメータを可変長にしたstd::is_same](exercise_q.md#SS_19_11_10)へ戻る。


### 20.11.11 解答例-メンバ関数の存在の診断 <a id="SS_20_11_11"></a>
```cpp
...
* [演習-メンバ関数の存在の診断](exercise_q.md#SS_19_11_11)へ戻る。


### 20.11.12 解答例-範囲for文のオペランドになれるかどうかの診断 <a id="SS_20_11_12"></a>
```cpp
...
* [演習-範囲for文のオペランドになれるかどうかの診断](exercise_q.md#SS_19_11_12)へ戻る。


### 20.11.13 解答例-配列の長さの取り出し <a id="SS_20_11_13"></a>
```cpp
...
* [演習-配列の長さの取り出し](exercise_q.md#SS_19_11_13)へ戻る。


### 20.11.14 解答例-配列の次元の取り出し <a id="SS_20_11_14"></a>
```cpp
...
* [演習-配列の次元の取り出し](exercise_q.md#SS_19_11_14)へ戻る。


### 20.11.15 解答例-関数型のテンプレートパラメータを持つクラステンプレート <a id="SS_20_11_15"></a>
```cpp
...
* [演習-関数型のテンプレートパラメータを持つクラステンプレート](exercise_q.md#SS_19_11_15)へ戻る。
