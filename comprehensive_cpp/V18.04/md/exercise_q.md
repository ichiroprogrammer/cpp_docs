...
## プログラミング規約(型) <a id="SS_19_1"></a>

### 演習-汎整数型の選択 <a id="SS_19_1_1"></a>
* 問題  
...
### 演習-const/constexpr <a id="SS_19_1_9"></a>
* 問題
```cpp
...
### 演習-危険なconst_cast <a id="SS_19_1_10"></a>
* 問題
```cpp
...
### 演習-適切なautoの使い方 <a id="SS_19_1_12"></a>
* 問題  
...
### 演習-vector初期化 <a id="SS_19_1_14"></a>
* 問題  
  以下のコード実行後のvecの状態を選べ。
...
### 演習-インスタンスの初期化 <a id="SS_19_1_15"></a>
* 問題
```cpp
...
## プログラミング規約(クラス) <a id="SS_19_2"></a>

### 演習-凝集度の意味 <a id="SS_19_2_1"></a>
* 問題  
...
### 演習-メンバ変数の初期化方法の選択 <a id="SS_19_2_3"></a>
* 問題  
...
### 演習-オブジェクトの所有権 <a id="SS_19_2_7"></a>
* 問題
```cpp
...
## プログラミング規約(関数) <a id="SS_19_3"></a>

### 演習-非メンバ関数の宣言 <a id="SS_19_3_1"></a>
* 問題
```cpp
...
### 演習-特殊メンバ関数の削除 <a id="SS_19_3_3"></a>
* 問題
```cpp
...
### 演習-copyコンストラクタ <a id="SS_19_3_5"></a>
* 問題
```cpp
...
### 演習-moveコンストラクタ <a id="SS_19_3_6"></a>
* 問題
```cpp
...
### 演習-オーバーライド関数の修飾 <a id="SS_19_3_8"></a>
* 問題  
...
### 演習-オーバーライド/オーバーロード <a id="SS_19_3_9"></a>
* 問題
```cpp
...
### 演習-オーバーロードによる誤用防止 <a id="SS_19_3_10"></a>
* 問題
```cpp
...
### 演習-constexpr関数 <a id="SS_19_3_12"></a>
* 問題
```cpp
...
### 演習-エクセプションの型 <a id="SS_19_3_13"></a>
* 問題  
...
## プログラミング規約(構文) <a id="SS_19_4"></a>

### 演習-コンテナの範囲for文 <a id="SS_19_4_1"></a>
* 問題
```cpp
...
### 演習-ラムダ式のキャプチャ <a id="SS_19_4_3"></a>
* 問題
```cpp
...
## プログラミング規約(演算子) <a id="SS_19_5"></a>

### 演習-三項演算子 <a id="SS_19_5_1"></a>
* 問題
```cpp
...
### 演習-dynamic_castの削除 <a id="SS_19_5_4"></a>
* 問題
```cpp
...
## プログラミング規約(スコープ) <a id="SS_19_6"></a>

### 演習-usingディレクティブ <a id="SS_19_6_1"></a>
* 問題  
...
## プログラミング規約(その他) <a id="SS_19_7"></a>

### 演習-アサーションの選択 <a id="SS_19_7_1"></a>
* 問題  
...
### 演習-assert/static_assert <a id="SS_19_7_2"></a>
* 問題
```cpp
...
## デザインパターン <a id="SS_19_9"></a>
### 演習-ガード節 <a id="SS_19_9_1"></a>
* 問題
```cpp
...
### 演習-BitmaskType <a id="SS_19_9_2"></a>
* 問題
```cpp
...
### 演習-Accessorの副作用 <a id="SS_19_9_4"></a>
* 問題  
...
### 演習-Copy-And-Swap <a id="SS_19_9_6"></a>
* 問題
```cpp
...
### 演習-Singleton <a id="SS_19_9_14"></a>
* 問題
```cpp
...
### 演習-Null Object <a id="SS_19_9_16"></a>
* 問題
```cpp
...
### 演習-Templateメソッド <a id="SS_19_9_17"></a>
* 問題
```cpp
...
### 演習-Named Constructor <a id="SS_19_9_19"></a>
* 問題
```cpp
...
### 演習-デザインパターン選択1 <a id="SS_19_9_25"></a>
* 問題  
  オブジェクトの状態と、
...
### 演習-デザインパターン選択2 <a id="SS_19_9_26"></a>
* 問題  
...
### 演習-デザインパターン選択3 <a id="SS_19_9_27"></a>
* 問題  
...
## 開発プロセスとインフラ(全般) <a id="SS_19_10"></a>

### 演習-プロセス分類 <a id="SS_19_10_1"></a>
* 問題  
...
### 演習-リファクタリングに付随する活動 <a id="SS_19_10_6"></a>
* 問題  
...
### 演習-リファクタリング対象コード <a id="SS_19_10_7"></a>
* 問題  
...
## テンプレートメタプログラミング <a id="SS_19_11"></a>

### 演習-パラメータパック <a id="SS_19_11_1"></a>
* 問題
```cpp
...
### 演習-エイリアステンプレート <a id="SS_19_11_2"></a>
* 問題
```cpp
...
### 演習-名前空間による修飾不要なoperator\<\< <a id="SS_19_11_3"></a>
* 問題
```cpp
...
### 演習-std::arrayの継承 <a id="SS_19_11_4"></a>
* 問題
```cpp
...
### 演習-SFINAEを利用しない関数テンプレートの特殊化によるis_void <a id="SS_19_11_5"></a>
* 問題
```cpp
...
### 演習-SFINAEを利用しないクラステンプレートの特殊化によるis_void <a id="SS_19_11_6"></a>
* 問題
...
### 演習-SFINAEを利用した関数テンプレートの特殊化によるis_void <a id="SS_19_11_7"></a>
* 問題
```cpp
...
### 演習-SFINAEを利用したクラステンプレートの特殊化によるis_void <a id="SS_19_11_8"></a>
* 問題
```cpp
...
### 演習-テンプレートテンプレートパラメータ <a id="SS_19_11_9"></a>
* 問題
```cpp
...
### 演習-テンプレートパラメータを可変長にしたstd::is_same <a id="SS_19_11_10"></a>
* 問題
```cpp
...
### 演習-メンバ関数の存在の診断 <a id="SS_19_11_11"></a>
* 問題
```cpp
...
### 演習-範囲for文のオペランドになれるかどうかの診断 <a id="SS_19_11_12"></a>
* 問題
```cpp
...
### 演習-配列の長さの取り出し <a id="SS_19_11_13"></a>
* 問題
```cpp
...
### 演習-配列の次元の取り出し <a id="SS_19_11_14"></a>
* 問題
```cpp
...
### 演習-関数型のテンプレートパラメータを持つクラステンプレート <a id="SS_19_11_15"></a>
* 問題
```cpp
