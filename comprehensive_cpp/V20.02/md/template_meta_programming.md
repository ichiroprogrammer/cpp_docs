...
(「[浮動小数点型](term_explanation.md#SS_19_1_9)」参照)
...
上記を抜粋した下記のコードは「縮小型変換を発生さる{}による初期化は[ill-formed](term_explanation.md#SS_19_18_5)になる」
ことをSFINAEに利用している。
...
* [ill-formed](term_explanation.md#SS_19_18_5)ならばill-formedになる
* [well-formed](term_explanation.md#SS_19_18_6)ならvoidを生成する
...
の戻り型が配列型の[rvalue](term_explanation.md#SS_19_14_3)である"int (&&) [3]"となり、
...
そのオブジェクトが[lvalue](term_explanation.md#SS_19_14_2)(この例ではint (&)[3])であれば、
...
実際、現在使用中の[g++](term_explanation.md#SS_19_19_1)ではこのコードはコンパイルできず、
...
[浮動小数点型](term_explanation.md#SS_19_1_9)を頻繁に使用するソフトウェアの開発を行うに場合、
ソースコードの中で、場当たり的に浮動小数点型を使用すると、
[浮動小数点の誤差](term_explanation.md#SS_19_1_9_2)や[浮動小数点の演算エラー](term_explanation.md#SS_19_1_9_4)
...
[ユニバーサルリファレンス](term_explanation.md#SS_19_15_1)を使って下記のように書き直した。
...
この原因は、
「関数が受け取った[rvalue](term_explanation.md#SS_19_14_3)リファレンスは、
その関数から別の関数に受け渡される時に[lvalue](term_explanation.md#SS_19_14_2)リファレンスとして扱われる」からである。
...
(T const&&はconstな[rvalue](term_explanation.md#SS_19_14_3)リファレンスである)、
ユニバーサルリファレンスが[lvalue](term_explanation.md#SS_19_14_2)リファレンスであった場合は、
...
なお、ユニバーサルリファレンスは、[リファレンスcollapsing](term_explanation.md#SS_19_15_4)の一機能としても理解できる。
...
残念なことにこの関数は非標準であるため、
それを使っているNstd::Inner\_::demangleは[g++](term_explanation.md#SS_19_19_1)/[clang++](term_explanation.md#SS_19_19_2)
でなければコンパイルできないだろう。
...
* ユニバーサルリファレンス引数を他の関数に渡すのであれば、std::forwardを使う
  (「[ユニバーサルリファレンス](term_explanation.md#SS_19_15_1)」、「[ユニバーサルリファレンスとstd::forward](template_meta_programming.md#SS_13_7_1)」参照)。
