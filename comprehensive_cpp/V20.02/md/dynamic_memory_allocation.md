...
[フリースタンディング環境](term_explanation.md#SS_19_20_1)では、sbrkのようなシステムコールは存在しないため、
...
* 複数個のメモリプールを統合的に扱う[インターフェースクラス](term_explanation.md#SS_19_3_12)MPool
...
コンパイラに[g++](term_explanation.md#SS_19_19_1)や[clang++](term_explanation.md#SS_19_19_2)を使っている場合、
...
[std::pmr::polymorphic_allocator](dynamic_memory_allocation.md#SS_14_5_2)を通じて利用可能にする[インターフェースクラス](term_explanation.md#SS_19_3_12)である。
