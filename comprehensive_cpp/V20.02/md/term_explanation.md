...
&emsp;&emsp;&emsp; [浮動小数点型](term_explanation.md#SS_19_1_9)  
&emsp;&emsp;&emsp;&emsp; [浮動小数点型のダイナミックレンジ](term_explanation.md#SS_19_1_9_1)  
&emsp;&emsp;&emsp;&emsp; [浮動小数点の誤差](term_explanation.md#SS_19_1_9_2)  
&emsp;&emsp;&emsp;&emsp; [イプシロン](term_explanation.md#SS_19_1_9_3)  
&emsp;&emsp;&emsp;&emsp; [浮動小数点の演算エラー](term_explanation.md#SS_19_1_9_4)  
...
&emsp;&emsp;&emsp; [標準レイアウト型](term_explanation.md#SS_19_3_3)  
&emsp;&emsp;&emsp; [集成体](term_explanation.md#SS_19_3_4)  
&emsp;&emsp;&emsp; [POD](term_explanation.md#SS_19_3_5)  
&emsp;&emsp;&emsp; [不完全型](term_explanation.md#SS_19_3_6)  
&emsp;&emsp;&emsp; [完全型](term_explanation.md#SS_19_3_7)  
&emsp;&emsp;&emsp; [ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)  
&emsp;&emsp;&emsp; [オーバーライドとオーバーロードの違い](term_explanation.md#SS_19_3_9)  
&emsp;&emsp;&emsp; [RTTI](term_explanation.md#SS_19_3_10)  
&emsp;&emsp;&emsp;&emsp; [dynamic_cast](term_explanation.md#SS_19_3_10_1)  
&emsp;&emsp;&emsp;&emsp; [typeid](term_explanation.md#SS_19_3_10_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_info](term_explanation.md#SS_19_3_10_3)  

&emsp;&emsp;&emsp; [Run-time Type Information](term_explanation.md#SS_19_3_11)  
&emsp;&emsp;&emsp; [インターフェースクラス](term_explanation.md#SS_19_3_12)  
&emsp;&emsp;&emsp; [constインスタンス](term_explanation.md#SS_19_3_13)  
...
&emsp;&emsp;&emsp;&emsp; [初期化付きif文](term_explanation.md#SS_19_7_5_2)  
&emsp;&emsp;&emsp;&emsp; [初期化付きswitch文](term_explanation.md#SS_19_7_5_3)  
...
&emsp;&emsp;&emsp; [hidden-friend関数](term_explanation.md#SS_19_10_7)  
&emsp;&emsp;&emsp; [name-hiding](term_explanation.md#SS_19_10_8)  
&emsp;&emsp;&emsp; [ダイヤモンド継承](term_explanation.md#SS_19_10_9)  
&emsp;&emsp;&emsp; [仮想継承](term_explanation.md#SS_19_10_10)  
&emsp;&emsp;&emsp; [仮想基底](term_explanation.md#SS_19_10_11)  
&emsp;&emsp;&emsp; [ドミナンス](term_explanation.md#SS_19_10_12)  
&emsp;&emsp;&emsp;&emsp; [ダイヤモンド継承を含まない場合](term_explanation.md#SS_19_10_12_1)  
&emsp;&emsp;&emsp;&emsp; [ダイヤモンド継承かつそれが仮想継承でない場合](term_explanation.md#SS_19_10_12_2)  
&emsp;&emsp;&emsp;&emsp; [ダイヤモンド継承かつそれが仮想継承である場合](term_explanation.md#SS_19_10_12_3)  

&emsp;&emsp;&emsp; [using宣言](term_explanation.md#SS_19_10_13)  
&emsp;&emsp;&emsp; [usingディレクティブ](term_explanation.md#SS_19_10_14)  
...
&emsp;&emsp;&emsp; [強い保証](term_explanation.md#SS_19_16_2)  
&emsp;&emsp;&emsp; [基本保証](term_explanation.md#SS_19_16_3)  
...
&emsp;&emsp;&emsp; [凝集度](term_explanation.md#SS_19_20_2)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](term_explanation.md#SS_19_20_3)  
...
特別なキーワードを使用して直接宣言できる型の総称である。[組み込み型](term_explanation.md#SS_19_1_2)とも呼ばれることもある。

基本型は以下のに示した型によって構成される。

* [算術型](term_explanation.md#SS_19_1_3)
* [汎整数型](term_explanation.md#SS_19_1_4)
* [浮動小数点型](term_explanation.md#SS_19_1_9)
* void
* 上記した型のポインタ型
...
* [浮動小数点型](term_explanation.md#SS_19_1_9)(float、double、long double)
...
#### 浮動小数点型のダイナミックレンジ <a id="SS_19_1_9_1"></a>
...
#### 浮動小数点の演算エラー <a id="SS_19_1_9_4"></a>
...
「型が[トリビアル型](term_explanation.md#SS_19_3_2)且つ[標準レイアウト型](term_explanation.md#SS_19_3_3)であること」と
「型が[POD](term_explanation.md#SS_19_3_5)であること」は等価であるため、C++20では、
...
### 完全型 <a id="SS_19_3_7"></a>
[不完全型](term_explanation.md#SS_19_3_6)ではない型を指す。

### ポリモーフィックなクラス <a id="SS_19_3_8"></a>
ポリモーフィックなクラスとは仮想関数を持つクラスや、
ポリモーフィックなクラスから派生したクラスを指す。
なお、純粋仮想関数を持つクラスは、
仮想クラスと呼ばれれる(「[インターフェースクラス](term_explanation.md#SS_19_3_12)」参照)。
ポリモーフィックなクラスと、
非ポリモーフィックなクラスは[RTTI](term_explanation.md#SS_19_3_10)との組み合わせで動作の違いが顕著となる。

非ポリモーフィックなクラスは非静的なメンバ変数が定義された順にメモリ上に配置されたレイアウトを持つ
(CPUアーキテクチャに依存したパディング領域が変数間に挿入されることもある)。
このようなクラスは[POD](term_explanation.md#SS_19_3_5)
(C++20では、[PODという用語は非推奨](https://cpprefjp.github.io/lang/cpp20/deprecate_pod.html)
となり、[トリビアル型](term_explanation.md#SS_19_3_2)と[標準レイアウト型](term_explanation.md#SS_19_3_3)に用語が分割された)とも呼ばれ、
C言語の構造体のレイアウトと互換性を持つことが一般的である。

ポリモーフィックなクラスは、
仮想関数呼び出しを行う(「[オーバーライドとオーバーロードの違い](term_explanation.md#SS_19_3_9)」参照)
ためのメモリレイアウトが必要になる。
...
### オーバーライドとオーバーロードの違い <a id="SS_19_3_9"></a>
下記例では、Base::g()がオーバーロードで、Derived::f()がオーバーライドである
(Derived::g()はオーバーロードでもオーバーライドでもない(「[name-hiding](term_explanation.md#SS_19_10_8)」参照))。
...
### RTTI <a id="SS_19_3_10"></a>
RTTI(Run-time Type Information)とは、プログラム実行中のオブジェクトの型を導出するための機能であり、
具体的には下記の3つの要素を指す。

* [dynamic_cast](term_explanation.md#SS_19_3_10_1)
* [typeid](term_explanation.md#SS_19_3_10_2)
* [std::type_info](term_explanation.md#SS_19_3_10_3)


#### dynamic_cast <a id="SS_19_3_10_1"></a>
dynamic_castは、実行時の型チェックと安全なダウンキャストを行うためのキャスト演算子であるため、
[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)とは密接な関係を持つ。


下記のような[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)に対しては、
...
一方で、下記のような非[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)に対しては、
...
#### typeid <a id="SS_19_3_10_2"></a>
typeidは[RTTI](term_explanation.md#SS_19_3_10)オブジェクトの型情報
([std::type_info](term_explanation.md#SS_19_3_10_3))を実行時に取得するための演算子である。
dynamic_castとは違い、
typeidのオペランドは[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)のインスタンスでなくても良い。
以下の例では[基本型](term_explanation.md#SS_19_1_1)に対するtypeidが返す[std::type_info](term_explanation.md#SS_19_3_10_3)の振る舞いを表す。
...
下記のような[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)のインスタンスに関して、
...
typeidが返す[std::type_info](term_explanation.md#SS_19_3_10_3)オブジェクトは下記のように振舞う。
...
[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)のオブジェクトをオペランドとするtypeidの実行は、
...
一方、非[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)のオブジェクトをオペランドとするtypeidのオペランド式は、
...
#### std::type_info <a id="SS_19_3_10_3"></a>
...
### Run-time Type Information <a id="SS_19_3_11"></a>
「[RTTI](term_explanation.md#SS_19_3_10)」を参照せよ。


### インターフェースクラス <a id="SS_19_3_12"></a>
...
1. 以下のいずれかに該当する式であること  
   ...
   - constexpr関数呼び出し
   - sizeof演算子の適用結果
   - typeid演算子の適用結果(式の値が[ポリモーフィックなクラス](term_explanation.md#SS_19_3_8)である場合を除く)
...
- [初期化付きif文](term_explanation.md#SS_19_7_5_2)
- [初期化付きswitch文](term_explanation.md#SS_19_7_5_3)
...
#### 初期化付きswitch文 <a id="SS_19_7_5_3"></a>
...
3. TypeNameは関数テンプレートであるためtwo phase lookupが以下のように行われる。
    ...
    2. TypeName内でのToType(t)の呼び出しに対しては、2nd name lookupが行われる。
       ...
       グローバル名前空間内のToTypeは、
       NS_TPLU内でTypeNameより前に宣言されたtemplate<> ToTypeによって[name-hiding](term_explanation.md#SS_19_10_8)が起こり、
...
### hidden-friend関数 <a id="SS_19_10_7"></a>
...
下記のように[using宣言](term_explanation.md#SS_19_10_13)を使用することで、
...
次に示すのは、[仮想継承](term_explanation.md#SS_19_10_10)を使用したダイヤモンド継承の例である。
...
(が、[仮想継承](term_explanation.md#SS_19_10_10)による別の問題が発生する)。
...
仮想継承は、[ダイヤモンド継承](term_explanation.md#SS_19_10_9)の基底クラスのインスタンスを、
...
[ダイヤモンド継承](term_explanation.md#SS_19_10_9)での基底クラスのコンストラクタ呼び出しを一度にするために存在する。
...
### 仮想基底 <a id="SS_19_10_11"></a>
仮想基底(クラス)とは、[仮想継承](term_explanation.md#SS_19_10_10)の基底クラス指す。

### ドミナンス <a id="SS_19_10_12"></a>
...
* [ダイヤモンド継承を含まない場合](term_explanation.md#SS_19_10_12_1)
* [ダイヤモンド継承かつそれが仮想継承でない場合](term_explanation.md#SS_19_10_12_2)
* [ダイヤモンド継承かつそれが仮想継承である場合](term_explanation.md#SS_19_10_12_3)

のドミナンスについてのコードを例示する。

この例で示したように、[ダイヤモンド継承](term_explanation.md#SS_19_10_9)を通常の継承で行うか、
[仮想継承](term_explanation.md#SS_19_10_10)で行うかでは結果が全く異なるため、注意が必要である。

#### ダイヤモンド継承を含まない場合 <a id="SS_19_10_12_1"></a>
...
この[name lookup](term_explanation.md#SS_19_10_2)については、[name-hiding](term_explanation.md#SS_19_10_8)で説明した通りである。

#### ダイヤモンド継承かつそれが仮想継承でない場合 <a id="SS_19_10_12_2"></a>
...
#### ダイヤモンド継承かつそれが仮想継承である場合 <a id="SS_19_10_12_3"></a>
...
これまでと同様にDerived_0のドミナンスによりBase::fは[name-hiding](term_explanation.md#SS_19_10_8)されることになる。
この時、Derived_0、Derived_1がBaseから[仮想継承](term_explanation.md#SS_19_10_10)した効果により、
この継承ヒエラルキーの中でBaseは１つのみ存在することになるため、
Derived_1により導入されたBase::fも併せて[name-hiding](term_explanation.md#SS_19_10_8)される。
結果として、曖昧性は排除され、コンパイルエラーにはならず、このような結果となる。

### using宣言 <a id="SS_19_10_13"></a>
...
### usingディレクティブ <a id="SS_19_10_14"></a>
...
[using宣言](term_explanation.md#SS_19_10_13)よりも危険であり、また、
下記のように[name-hiding](term_explanation.md#SS_19_10_8)された識別子の導入には効果がない。
...
* [強い保証](term_explanation.md#SS_19_16_2)
* [基本保証](term_explanation.md#SS_19_16_3)
...
この問題は、「[RTTI](term_explanation.md#SS_19_3_10)」使った下記のようなコードで対処できる。
...
* 「[Accessor](design_pattern.md#SS_9_4)」を多用すれば凝集度は低くなる。従って、下記のようなクラスは凝集度が低い。
...
### サイクロマティック複雑度 <a id="SS_19_20_3"></a>
