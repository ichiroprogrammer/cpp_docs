...
|[rvalue](term_explanation.md#SS_19_14_3)/[moveセマンティクス](term_explanation.md#SS_19_17_3)|[オブジェクトの所有権](term_explanation.md#SS_19_5_7)の移転、高速化。              |
|[ラムダ式](term_explanation.md#SS_19_8_3)                                      |関数オブジェクトをその場に書く                                              |
|[noexcept](term_explanation.md#SS_19_16_4)                                               |関数の例外指定、例外を投げる可能性のある式かbool値を返す演算子              |
...
|メンバ関数の[rvalue修飾](term_explanation.md#SS_19_14_4)/[lvalue修飾](term_explanation.md#SS_19_14_5)              |オブジェクトの[expressionと値カテゴリ](term_explanation.md#SS_19_14)での呼び出し可能であることの指定|
...
|[エイリアステンプレート](term_explanation.md#SS_19_11_8)       |エイリアスをテンプレート化できる                                                           |
...
|任意の式による[SFINAE](term_explanation.md#SS_19_11_1)         |特定の式が[ill-formed](term_explanation.md#SS_19_18_5)か否かで、その関数をオーバーロード解決に含めるかどうかを決定する|
|テンプレートのエクスポート機能      |削除                                                                                       |
...
[コンテナ](term_explanation.md#SS_19_9_2)全般が[moveセマンティクス](term_explanation.md#SS_19_17_3)に対応したため、
...
[rvalue](term_explanation.md#SS_19_14_3)オブジェクトも受け取れて、
...
|[関数の戻り値型auto](term_explanation.md#SS_19_12_5)                           |戻り値の型を後置する関羽鵜テンプレート/関数定義とラムダ式の戻り値型にautoに      |
...
|[変数テンプレート](term_explanation.md#SS_19_11_7)            |変数定義時のテンプレート指定を可能に                                             |
|constexpr関数内での条件分岐とループの文を許可       |[constexpr if文](term_explanation.md#SS_19_11_9)                                                            |
...
|[heap allocation elision](term_explanation.md#SS_19_18_15)                      |動的メモリ確保の省略(heap allocation elision)の許可                              |
...
|[RVO(Return Value Optimization)](term_explanation.md#SS_19_18_13)        |右辺値を変数の初期化のために使用する場合、コピーもムーブも省略することを保証                       |
|[演算子のオペランドの評価順位](term_explanation.md#SS_19_18_2)          |C++14まで未規定であった部分式の評価順序を規定                                                      |
...
|[constexpr if文](term_explanation.md#SS_19_11_9)                        |if constexpr(cond) とすることで、その if 文はコンパイル時に処理                                    |
...
|const修飾されたメンバポインタの制限を修正      |`.*`演算子での[lvalue](term_explanation.md#SS_19_14_2)のconstメンバ関数呼び出しを許可                                          |
...
|[autoパラメータによる関数テンプレートの簡易定義](term_explanation.md#SS_19_11_10)  |[ジェネリックラムダ](term_explanation.md#SS_19_11_4)と同様に関数パラメータをの型をautoにできる。           |
