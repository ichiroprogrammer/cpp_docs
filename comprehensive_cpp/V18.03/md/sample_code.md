...
## etc <a id="SS_23_3"></a>
### example/deps/dependency/CMakeLists.txt <a id="SS_23_3_1"></a>
```
...
### example/deps/file_utils/CMakeLists.txt <a id="SS_23_3_2"></a>
```
          1 cmake_minimum_required(VERSION 3.10)
          2 
...
### example/deps/lib/CMakeLists.txt <a id="SS_23_3_3"></a>
```
          1 cmake_minimum_required(VERSION 3.10)
          2 
...
### example/deps/logging/CMakeLists.txt <a id="SS_23_3_4"></a>
```
