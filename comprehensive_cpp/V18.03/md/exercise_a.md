...
### 解答例-配列の範囲for文 <a id="SS_20_1_6"></a>
```cpp
...
### 解答例-危険なconst_cast <a id="SS_20_1_10"></a>
```cpp
...
### 解答例-メンバ変数の初期化 <a id="SS_20_2_5"></a>
```cpp
...
### 解答例-オブジェクトの所有権 <a id="SS_20_2_7"></a>
```cpp
...
### 解答例-非メンバ関数の宣言 <a id="SS_20_3_1"></a>
```cpp
...
### 解答例-特殊メンバ関数の削除 <a id="SS_20_3_3"></a>
```cpp
...
### 解答例-委譲コンストラクタ <a id="SS_20_3_4"></a>
```cpp
...
### 解答例-copyコンストラクタ <a id="SS_20_3_5"></a>
```cpp
...
### 解答例-moveコンストラクタ <a id="SS_20_3_6"></a>
```cpp
...
### 解答例-オーバーロードによる誤用防止 <a id="SS_20_3_10"></a>
```cpp
...
### 解答例-constexpr関数 <a id="SS_20_3_12"></a>
```cpp
...
### 解答-エクセプションの型 <a id="SS_20_3_13"></a>
* 選択肢2
...
### 解答例-コンテナの範囲for文 <a id="SS_20_4_1"></a>
```cpp
...
### 解答例-ラムダ式のキャプチャ <a id="SS_20_4_3"></a>
```cpp
...
### 解答例-dynamic_castの削除 <a id="SS_20_5_4"></a>
```cpp
...
### 解答-usingディレクティブ <a id="SS_20_6_1"></a>
* 選択肢1
...
### 解答例-BitmaskType <a id="SS_20_9_2"></a>
```cpp
...
### 解答例-Copy-And-Swap <a id="SS_20_9_6"></a>
```cpp
...
### 解答例-Immutable <a id="SS_20_9_7"></a>
```cpp
...
### 解答例-Singleton <a id="SS_20_9_14"></a>
```cpp
...
### 解答例-Null Object <a id="SS_20_9_16"></a>
```cpp
...
### 解答例-Templateメソッド <a id="SS_20_9_17"></a>
```cpp
...
### 解答例-Named Constructor <a id="SS_20_9_19"></a>
```cpp
...
### 解答例-Strategy <a id="SS_20_9_21"></a>
```cpp
...
### 解答例-Observer <a id="SS_20_9_24"></a>
```cpp
...
### 解答例-パラメータパック <a id="SS_20_11_1"></a>
```cpp
...
### 解答例-エイリアステンプレート <a id="SS_20_11_2"></a>
```cpp
...
### 解答例-名前空間による修飾不要なoperator\<\< <a id="SS_20_11_3"></a>
```cpp
...
### 解答例-std::arrayの継承 <a id="SS_20_11_4"></a>
```cpp
...
### 解答例-SFINAEを利用しない関数テンプレートの特殊化によるis_void <a id="SS_20_11_5"></a>
```cpp
...
### 解答例-SFINAEを利用しないクラステンプレートの特殊化によるis_void <a id="SS_20_11_6"></a>
```cpp
...
### 解答例-SFINAEを利用した関数テンプレートの特殊化によるis_void <a id="SS_20_11_7"></a>
```cpp
...
### 解答例-SFINAEを利用したクラステンプレートの特殊化によるis_void <a id="SS_20_11_8"></a>
```cpp
...
### 解答例-テンプレートテンプレートパラメータ <a id="SS_20_11_9"></a>
```cpp
...
### 解答例-テンプレートパラメータを可変長にしたstd::is_same <a id="SS_20_11_10"></a>
```cpp
...
### 解答例-メンバ関数の存在の診断 <a id="SS_20_11_11"></a>
```cpp
...
### 解答例-範囲for文のオペランドになれるかどうかの診断 <a id="SS_20_11_12"></a>
```cpp
...
### 解答例-配列の長さの取り出し <a id="SS_20_11_13"></a>
```cpp
...
### 解答例-配列の次元の取り出し <a id="SS_20_11_14"></a>
```cpp
...
### 解答例-関数型のテンプレートパラメータを持つクラステンプレート <a id="SS_20_11_15"></a>
```cpp
